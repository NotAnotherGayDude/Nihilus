...
int32_t main(int32_t argc, char** argv) {
	...
	constexpr auto model_config_03 = generate_model_config(model_generations::v3_1, model_sizes::llm_8B, kernel_type_profiles::q8_gqa, model_arches::llama, true, nullptr, 2048);
	auto model_new_03{ harbinger<model_config_03>::parse_model_graph_data(cli_args) };

	constexpr auto model_config_04 = generate_model_config(model_generations::v3_1, model_sizes::llm_8B, kernel_type_profiles::q8_gqa, model_arches::llama, true, nullptr,
