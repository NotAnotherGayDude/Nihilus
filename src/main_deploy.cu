...
static constexpr auto model_config_01 =
	nihilus::generate_model_config(nihilus::model_generations::v3_1, nihilus::model_sizes::llm_405B, nihilus::kernel_type_profiles::q8_gqa, nihilus::model_arches::llama,
