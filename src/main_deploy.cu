...
static constexpr auto model_config_01 = nihilus::generate_model_config(nihilus::model_sizes::llm_8B, nihilus::kernel_type_profiles::q8_gqa, nihilus::device_types::gpu,
	nihilus::model_generations::v3_1, nihilus::exception_type::enabled, nihilus::default_max_sequence_length_type{ 131072 }, nihilus::model_arches::llama);
