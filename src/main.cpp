...
int32_t main(int32_t argc, char** argv) {
	...
	static constexpr auto model_config_00 =
		generate_model_config(model_generations::v3_1, model_sizes::llm_8B, kernel_type_profiles::q8_gqa, model_arches::llama, nihilus::device_types::cpu, true, false, 2048);
