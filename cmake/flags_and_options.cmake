...
set(NIHILUS_COMPILE_DEFINITIONS
    ...
    "$<IF:$<CONFIG:Release>,NIHILUS_DEV=0,NIHILUS_DEV=1>"
    "NIHILUS_INLINE=$<IF:$<CUDA_COMPILER_ID:NVIDIA>,${NIHILUS_CUDA_INLINE_KEYWORD},${NIHILUS_INLINE_KEYWORD}>"
...
set(NIHILUS_LINK_OPTIONS
    ...
    "$<$<CUDA_COMPILER_ID:NVIDIA>:-Xlinker=-O3,-s>"
)
