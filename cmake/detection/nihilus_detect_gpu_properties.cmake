...
if(NOT DEFINED NIHILUS_SM_COUNT OR 
   ...
   NOT DEFINED NIHILUS_GPU_L2_CACHE_SIZE OR
...
if(FEATURE_TESTER_EXIT_CODE EQUAL 0 AND GPU_PROPERTIES_OUTPUT MATCHES "GPU_SUCCESS=1")
    ...
    if(NOT DEFINED NIHILUS_GPU_L2_CACHE_SIZE)
        set(NIHILUS_GPU_L2_CACHE_SIZE "${CMAKE_MATCH_1}" CACHE STRING "GPU L2 cache size" FORCE)
    endif()
    ...
    if(NOT DEFINED NIHILUS_MAJOR_COMPUTE_CAPABILITY)
        ...
        message("NIHILUS_MAJOR_COMPUTE_CAPABILITY: ${NIHILUS_MAJOR_COMPUTE_CAPABILITY}")
    endif()
    ...
    if(NOT DEFINED NIHILUS_MINOR_COMPUTE_CAPABILITY)
        ...
        message("NIHILUS_MINOR_COMPUTE_CAPABILITY: ${NIHILUS_MINOR_COMPUTE_CAPABILITY}")
    endif()
    ...
    if(NOT DEFINED NIHILUS_GPU_L2_CACHE_SIZE)
        set(NIHILUS_GPU_L2_CACHE_SIZE "2097152" CACHE STRING "GPU L2 cache size (fallback)" FORCE)
    endif()
    if(NOT DEFINED NIHILUS_SHARED_MEM_PER_BLOCK)
