...
if(NOT DEFINED NIHILUS_CPU_ARCH_INDEX)
    ...
    elseif(NIHILUS_HAS_AVX2)
        ...
        set(NIHILUS_SIMD_FLAGS "$<IF:$<CUDA_COMPILER_ID:NVIDIA>,,$<IF:$<CXX_COMPILER_ID:MSVC>,/model_arch:AVX2,-mavx2;-mfma;-mavx;-mlzcnt;-mpopcnt;-mbmi;-mbmi2;-msse4.2;-mf16c>>" CACHE STRING "SIMD flags" FORCE)
