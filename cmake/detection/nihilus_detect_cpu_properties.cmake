...
if(NOT DEFINED NIHILUS_THREAD_COUNT OR 
   NOT DEFINED NIHILUS_L1_CACHE_SIZE OR 
...
if(FEATURE_TESTER_EXIT_CODE EQUAL 0 AND CPU_PROPERTIES_OUTPUT MATCHES "CPU_SUCCESS=1")
    ...
    if(NOT DEFINED NIHILUS_L1_CACHE_SIZE)
        set(NIHILUS_L1_CACHE_SIZE "${CMAKE_MATCH_1}" CACHE STRING "CPU L1 cache size" FORCE)
    endif()
    
    string(REGEX MATCH "L2_CACHE_SIZE=([0-9]+)" _ "${CPU_PROPERTIES_OUTPUT}")
    if(NOT DEFINED NIHILUS_L2_CACHE_SIZE)
        set(NIHILUS_L2_CACHE_SIZE "${CMAKE_MATCH_1}" CACHE STRING "CPU L2 cache size" FORCE)
    endif()
    
    string(REGEX MATCH "L3_CACHE_SIZE=([0-9]+)" _ "${CPU_PROPERTIES_OUTPUT}")
    if(NOT DEFINED NIHILUS_L3_CACHE_SIZE)
        set(NIHILUS_L3_CACHE_SIZE "${CMAKE_MATCH_1}" CACHE STRING "CPU L3 cache size" FORCE)
    endif()
    ...
    if(NOT DEFINED NIHILUS_L1_CACHE_SIZE)
        set(NIHILUS_L1_CACHE_SIZE "32768" CACHE STRING "CPU L1 cache size - 32KB (fallback)" FORCE)
    endif()
    if(NOT DEFINED NIHILUS_L2_CACHE_SIZE)
        set(NIHILUS_L2_CACHE_SIZE "262144" CACHE STRING "CPU L2 cache size - 256KB (fallback)" FORCE)
    endif()
    if(NOT DEFINED NIHILUS_L3_CACHE_SIZE)
        set(NIHILUS_L3_CACHE_SIZE "8388608" CACHE STRING "CPU L3 cache size - 8MB (fallback)" FORCE)
    endif()
endif()
...
if(NOT DEFINED NIHILUS_CPU_ARCH_INDEX)
    if(NIHILUS_HAS_AVX512)
        ...
        set(NIHILUS_CPU_ARCHITECTURE "2" CACHE STRING "CPU architecture" FORCE)
        set(NIHILUS_CPU_ALIGNMENT "64" CACHE STRING "CPU Alignment" FORCE)
        set(NIHILUS_SIMD_FLAGS "$<IF:$<CXX_COMPILER_ID:MSVC>,/arch:AVX512,-mavx512f;-mfma;-mavx2;-mavx;-mlzcnt;-mpopcnt;-mbmi;-mbmi2;-msse4.2;-mf16c>" CACHE STRING "SIMD flags" FORCE)
    ...
    elseif(NIHILUS_HAS_AVX2)
        ...
        set(NIHILUS_CPU_ARCHITECTURE "1" CACHE STRING "CPU architecture" FORCE)
        set(NIHILUS_CPU_ALIGNMENT "32" CACHE STRING "CPU Alignment" FORCE)
        set(NIHILUS_SIMD_FLAGS "$<IF:$<CXX_COMPILER_ID:MSVC>,/arch:AVX2,-mfma;-mavx2;-mavx;-mlzcnt;-mpopcnt;-mbmi;-mbmi2;-msse4.2;-mf16c>" CACHE STRING "SIMD flags" FORCE)
    ...
    elseif(NIHILUS_HAS_SVE2)
        ...
        set(NIHILUS_CPU_ARCHITECTURE "2" CACHE STRING "CPU architecture" FORCE)
        set(NIHILUS_CPU_ALIGNMENT "64" CACHE STRING "CPU Alignment" FORCE)
        set(NIHILUS_SIMD_FLAGS "$<IF:$<CXX_COMPILER_ID:MSVC>,,-march=armv8-a+sve;-msve-vector-bits=scalable;-march=armv8-a+sve+sve2>" CACHE STRING "SIMD flags" FORCE)
    ...
    elseif(NIHILUS_HAS_NEON)
        ...
        set(NIHILUS_SIMD_FLAGS "$<IF:$<CXX_COMPILER_ID:MSVC>,,-march=armv8-a>" CACHE STRING "SIMD flags" FORCE)
        ...
        set(NIHILUS_CPU_ARCHITECTURE "0" CACHE STRING "CPU architecture" FORCE)
...
message(STATUS "CPU Configuration: ${NIHILUS_THREAD_COUNT} threads, L1: ${NIHILUS_L1_CACHE_SIZE}B, arch index: ${NIHILUS_CPU_ARCH_INDEX}")
