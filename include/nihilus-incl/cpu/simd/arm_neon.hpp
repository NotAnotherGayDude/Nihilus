...
namespace nihilus {
	...
	template<simd_int_128_type simd_int_type_new> NIHILUS_INLINE static simd_int_type_new gather_valuesU(const void* str, void*) noexcept {
		return vld1q_u8(static_cast<const uint8_t*>(str));
	}

	template<simd_int_128_type simd_int_type_new, typename char_t>
		requires(sizeof(char_t) == 8)
	NIHILUS_INLINE static simd_int_type_new gather_value(char_t str) noexcept {
	...
	template<simd_int_128_type simd_int_type_new> NIHILUS_INLINE static void storeU(const simd_int_type_new& value, void* storageLocation, void*) noexcept {
		vst1q_u8(static_cast<uint8_t*>(storageLocation), value);
	}
	...
	template<simd_int_128_type simd_int_t01> NIHILUS_INLINE static uint64_t opBitMaskRaw(const simd_int_t01& value) noexcept {
	...
	template<simd_int_128_type simd_int_t01, simd_int_128_type simd_int_t02>
	NIHILUS_INLINE static nihilus_simd_int_128 opXor(const simd_int_t01& value, const simd_int_t02& other) noexcept {
		return veorq_u8(value, other);
	}

	template<simd_int_128_type simd_int_t01, simd_int_128_type simd_int_t02>
	NIHILUS_INLINE static nihilus_simd_int_128 opAnd(const simd_int_t01& value, const simd_int_t02& other) noexcept {
		return vandq_u8(value, other);
	}

	template<simd_int_128_type simd_int_t01, simd_int_128_type simd_int_t02>
	NIHILUS_INLINE static nihilus_simd_int_128 opOr(const simd_int_t01& value, const simd_int_t02& other) noexcept {
		return vorrq_u8(value, other);
	}

	template<simd_int_128_type simd_int_t01, simd_int_128_type simd_int_t02>
	NIHILUS_INLINE static nihilus_simd_int_128 opAndNot(const simd_int_t01& value, const simd_int_t02& other) noexcept {
		return vbicq_u8(value, other);
	}

	template<simd_int_128_type simd_int_t01> NIHILUS_INLINE static bool opTest(const simd_int_t01& value) noexcept {
	...
	template<simd_int_128_type simd_int_t01> NIHILUS_INLINE static nihilus_simd_int_128 opSetLSB(const simd_int_t01& value, bool value_new) noexcept {
	...
	template<simd_int_128_type simd_int_t01> NIHILUS_INLINE static bool opGetMSB(const simd_int_t01& value) noexcept {
