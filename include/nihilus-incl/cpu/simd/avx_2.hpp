...
namespace nihilus {
	...
	NIHILUS_INLINE void dequantize_row_q8_0(const block_q8_0<half>* __restrict x, float* __restrict y, int64_t k) {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<1, kernel_types::get_rows, transform_type, core_type, float, block_q8_0<half>, int32_t>
		...
		static constexpr auto input01_dims = core_type::input_01_type::get_array();
		static constexpr auto input02_dims = core_type::input_02_type::get_array();
		static constexpr auto output_dims = core_type::get_array();
		static constexpr auto input01_strides = core_type::input_01_type::strides;
		static constexpr auto input02_strides = core_type::input_02_type::strides;
		static constexpr auto output_strides  = core_type::strides;
		NIHILUS_INLINE static void impl(uint64_t, uint64_t, core_type&, const typename core_type::input_01_type&, const typename core_type::input_02_type&) {
		}
	};
