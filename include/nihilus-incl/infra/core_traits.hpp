...
namespace nihilus {
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::weights>
		...
		using attn_q_weight_type = op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::per_block, weight_types::attn_q,
			kernel_types::weights, weight_type, kernel_dims<0, model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::embedding_length, 1, 1>>;
		...
		using attn_k_weight_type = op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::per_block, weight_types::attn_k,
			kernel_types::weights, weight_type, kernel_dims<0, model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::n_embd_kv_gqa, 1, 1>>;
		...
		using attn_output_weight_type =
			op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::per_block, weight_types::attn_output, kernel_types::weights,
				weight_type, kernel_dims<0, model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::embedding_length, 1, 1>>;
		...
		using attn_norm_weight_type = op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::per_block, weight_types::attn_norm,
			kernel_types::weights, norm_type, kernel_dims<0, model_traits_type<config_type>::embedding_length, 1, 1, 1>>;
		...
		using ffn_gate_weight_type = op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::per_block, weight_types::ffn_gate,
			kernel_types::weights, weight_type, kernel_dims<0, model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::feed_forward_length, 1, 1>>;
		...
		using ffn_down_weight_type = op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::per_block, weight_types::ffn_down,
			kernel_types::weights, weight_type, kernel_dims<0, model_traits_type<config_type>::feed_forward_length, model_traits_type<config_type>::embedding_length, 1, 1>>;
		...
		using token_embd_weight_type = op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::global, weight_types::token_embd,
			kernel_types::weights, weight_type, kernel_dims<0, model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::vocab_size, 1, 1>>;
		...
		using rope_freqs_weight_type = op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::global, weight_types::rope_freqs,
			kernel_types::weights, norm_type, kernel_dims<0, model_traits_type<config_type>::rope_dimension_count / 2, 1, 1, 1>>;
		...
		using output_norm_weight_type = op_traits<config_type, core_type, allocation_strategy_type<config_type::device_type>, data_strategy_types::global,
			weight_types::output_norm, kernel_types::weights, norm_type, kernel_dims<0, model_traits_type<config_type>::embedding_length, 1, 1, 1>>;
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::global_inputs>
		...
		using inp_tokens_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::inp_tokens,
			kernel_types::weights, typename kernel_profile_type::token_type, kernel_dims<3, config_type::batch_size, config_type::max_sequence_length, 1, 1>>;

		using inp_pos_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::inp_pos, kernel_types::weights,
			typename kernel_profile_type::token_type, kernel_dims<3, config_type::batch_size, config_type::max_sequence_length, 1, 1>>;

		using cache_k_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::cache_k, kernel_types::weights,
			typename kernel_profile_type::kv_cache_type,
		...
		using cache_v_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::cache_v, kernel_types::weights,
			typename kernel_profile_type::kv_cache_type,
			kernel_dims<3, config_type::batch_size * mtt::block_count, config_type::max_sequence_length, mtt::attention_head_count_kv, mtt::rope_dimension_count>>;

		using kq_mask_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::kq_mask, kernel_types::weights,
			typename kernel_profile_type::mask_type, kernel_dims<1, config_type::batch_size, mtt::block_count, mtt::block_count, 1>>;
		...
		using temperature_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::temperature,
			kernel_types::weights, float, kernel_dims<1, config_type::batch_size, 1, 1, 1>>;

		using top_k_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::top_k, kernel_types::weights,
			int32_t, kernel_dims<1, config_type::batch_size, 1, 1, 1>>;

		using top_p_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::top_p, kernel_types::weights, float,
			kernel_dims<1, config_type::batch_size, 1, 1, 1>>;
		...
		using rep_window_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::rep_window,
			kernel_types::weights, int32_t, kernel_dims<1, config_type::batch_size, 1, 1, 1>>;
		...
		using token_history_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::token_history,
			kernel_types::weights, int32_t, kernel_dims<3, config_type::batch_size, config_type::max_sequence_length, 1, 1>>;
		...
		using rng_state_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::rng_state,
			kernel_types::weights, uint64_t, kernel_dims<1, config_type::batch_size, 2, 1, 1>>;
		...
		using logits_bias_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::logits_bias,
			kernel_types::weights, float, kernel_dims<1, config_type::batch_size, mtt::vocab_size, 1, 1>>;
		...
		using allowed_vocab_mask_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, global_input_types::allowed_vocab_mask,
			kernel_types::weights, uint8_t, kernel_dims<1, config_type::batch_size, mtt::vocab_size, 1, 1>>;
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::token_embeddings>
		...
		using input_embedding_kernel_traits = kernel_traits<kernel_types_type<kernel_types::get_rows>, output_type, input_01_type, input_02_type>;
		...
		using token_embeddings_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, token_embeddings_types::get_rows,
			kernel_types::get_rows, output_type, input_01_type, input_02_type, input_embedding_kernel_traits>;
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::mega_qkv_prep_and_cache_publish>
		...
		using rms_norm_trait = kernel_traits<kernel_types_type<kernel_types::rms_norm>, compute_type, inp_embd_type>;

		using mul_trait = kernel_traits<kernel_types_type<kernel_types::mul>, compute_type, rms_norm_trait, attn_norm_w_type>;

		using q_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, attn_q_w_type, mul_trait>;

		using q_reshape_trait = kernel_traits<kernel_types_type<kernel_types::reshape>, compute_type,
		...
		using q_rope_trait = kernel_traits<kernel_types_type<kernel_types::rope>, q_reshape_trait, inp_pos_type, rope_freqs_type>;

		using k_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, attn_k_w_type, mul_trait>;

		using k_reshape_trait = kernel_traits<kernel_types_type<kernel_types::reshape>, compute_type,
		...
		using k_rope_trait = kernel_traits<kernel_types_type<kernel_types::rope>, k_reshape_trait, inp_pos_type, rope_freqs_type>;

		using v_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, attn_v_w_type, mul_trait>;

		using v_transpose_trait = kernel_traits<kernel_types_type<kernel_types::transpose>, compute_type,
			kernel_dims<3, config_type::batch_size, config_type::max_sequence_length, mtt::n_embd_kv_gqa, 1>, v_mul_mat_trait>;

		using k_cache_window_view_trait = kernel_traits<kernel_types_type<kernel_types::view>, kv_store_type,
		...
		using v_cache_window_view_trait = kernel_traits<kernel_types_type<kernel_types::view>, kv_store_type,
		...
		using k_cache_store_trait = kernel_traits<kernel_types_type<kernel_types::copy>, kv_store_type, k_rope_trait, k_cache_window_view_trait>;

		using v_cache_store_trait = kernel_traits<kernel_types_type<kernel_types::copy>, kv_store_type, v_transpose_trait, v_cache_window_view_trait>;
		...
		using q_out_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, mega_qkv_prep_and_cache_publish_types::q_out,
			kernel_types::rope, compute_type, inp_embd_type, rms_norm_trait, mul_trait, k_mul_mat_trait, k_reshape_trait, k_rope_trait, k_cache_window_view_trait,
			k_cache_store_trait, v_mul_mat_trait, v_transpose_trait, v_cache_window_view_trait, v_cache_store_trait, q_mul_mat_trait, q_reshape_trait, q_rope_trait>;
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::mega_attention_apply>
		...
		using k_cache_read_view_trait = kernel_traits<kernel_types_type<kernel_types::view>, kv_store_type,
			kernel_dims<5, config_type::batch_size, mtt::rope_dimension_count, config_type::max_sequence_length, mtt::attention_head_count_kv>, cache_k_type>;

		using v_cache_read_view_trait = kernel_traits<kernel_types_type<kernel_types::view>, kv_store_type,
			kernel_dims<3, config_type::batch_size, config_type::max_sequence_length, mtt::rope_dimension_count, mtt::attention_head_count_kv>, cache_v_type>;

		using q_input_trait = kernel_traits<kernel_types_type<kernel_types::weights>, compute_type,
			kernel_dims<5, config_type::batch_size, mtt::rope_dimension_count, config_type::max_sequence_length, mtt::attention_head_count>>;

		using kq_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, k_cache_read_view_trait, q_input_trait>;

		using softmax_trait = kernel_traits<kernel_types_type<kernel_types::softmax>, compute_type, kq_mul_mat_trait, kq_mask_type>;

		using kqv_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, v_cache_read_view_trait, softmax_trait>;

		using merge_permute_trait = kernel_traits<kernel_types_type<kernel_types::permute>, compute_type,
		...
		using cont_trait = kernel_traits<kernel_types_type<kernel_types::cont>, compute_type,
			kernel_dims<3, config_type::batch_size, mtt::embedding_length, config_type::max_sequence_length, 1>, merge_permute_trait>;

		using attn_out_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, attn_output_w_type, cont_trait>;

		using residual_add_trait = kernel_traits<kernel_types_type<kernel_types::add>, compute_type, attn_out_mul_mat_trait, inp_embd_type>;
		...
		using ffn_inp_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, mega_attention_apply_types::ffn_inp,
			kernel_types::add, compute_type, cache_k_type, cache_v_type, kq_mask_type, attn_output_w_type, inp_embd_type, k_cache_read_view_trait, v_cache_read_view_trait,
			q_input_trait, kq_mul_mat_trait, softmax_trait, kqv_mul_mat_trait, merge_permute_trait, cont_trait, attn_out_mul_mat_trait, residual_add_trait>;
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::mega_ffn>
		...
		using ffn_rms_norm_trait = kernel_traits<kernel_types_type<kernel_types::rms_norm>, compute_type, ffn_inp_trait>;

		using ffn_norm_mul_trait = kernel_traits<kernel_types_type<kernel_types::mul>, compute_type, ffn_rms_norm_trait, ffn_norm_w_type>;

		using ffn_gate_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, ffn_gate_w_type, ffn_norm_mul_trait>;

		using ffn_up_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, ffn_up_w_type, ffn_norm_mul_trait>;

		using ffn_silu_trait = kernel_traits<kernel_types_type<kernel_types::silu>, compute_type, ffn_gate_mul_mat_trait>;

		using ffn_gate_par_trait = kernel_traits<kernel_types_type<kernel_types::mul>, compute_type, ffn_silu_trait, ffn_up_mul_mat_trait>;

		using ffn_down_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, ffn_down_w_type, ffn_gate_par_trait>;

		using ffn_residual_add_trait = kernel_traits<kernel_types_type<kernel_types::add>, compute_type, ffn_down_mul_mat_trait, ffn_inp_trait>;

		using l_out_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global, mega_ffn_types::l_out, kernel_types::add, compute_type,
			ffn_norm_w_type, ffn_gate_w_type, ffn_up_w_type, ffn_down_w_type, ffn_inp_trait, ffn_rms_norm_trait, ffn_norm_mul_trait, ffn_gate_mul_mat_trait, ffn_up_mul_mat_trait,
			ffn_silu_trait, ffn_gate_par_trait, ffn_down_mul_mat_trait, ffn_residual_add_trait>;
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::final_norm_and_sampling>
		...
		using last_token_view_trait =
			kernel_traits<kernel_types_type<kernel_types::view>, compute_type, kernel_dims<5, config_type::batch_size, mtt::embedding_length, 1, 1>, l_out_trait>;

		using final_rms_norm_trait = kernel_traits<kernel_types_type<kernel_types::rms_norm>, compute_type, last_token_view_trait>;

		using final_norm_mul_trait = kernel_traits<kernel_types_type<kernel_types::mul>, compute_type, final_rms_norm_trait, output_norm_w_type>;

		using logits_mul_mat_trait = kernel_traits<kernel_types_type<kernel_types::mul_mat>, compute_type, output_w_type, final_norm_mul_trait>;

		using logits_bias_add_trait = kernel_traits<kernel_types_type<kernel_types::add>, compute_type, logits_mul_mat_trait, logits_bias_type>;

		using rep_penalty_trait =
			kernel_traits<kernel_types_type<kernel_types::repetition_penalty>, compute_type, logits_bias_add_trait, token_history_type, repetition_penalty_type>;

		using presence_penalty_trait = kernel_traits<kernel_types_type<kernel_types::presence_penalty>, compute_type, rep_penalty_trait, token_history_type, presence_penalty_type>;

		using frequency_penalty_trait =
			kernel_traits<kernel_types_type<kernel_types::frequency_penalty>, compute_type, presence_penalty_trait, token_history_type, frequency_penalty_type>;

		using vocab_mask_trait = kernel_traits<kernel_types_type<kernel_types::vocab_mask>, compute_type, frequency_penalty_trait, allowed_vocab_mask_type>;

		using temperature_scale_trait = kernel_traits<kernel_types_type<kernel_types::temperature_scale>, compute_type, vocab_mask_trait, temperature_type>;

		using top_k_filter_trait = kernel_traits<kernel_types_type<kernel_types::top_k_filter>, compute_type, temperature_scale_trait, top_k_type>;

		using top_p_filter_trait = kernel_traits<kernel_types_type<kernel_types::top_p_filter>, compute_type, top_k_filter_trait, top_p_type>;

		using sample_trait =
			kernel_traits<kernel_types_type<kernel_types::sample_logits>, int32_t, kernel_dims<3, config_type::batch_size, 1, 1, 1>, top_p_filter_trait, rng_state_type>;

		using result_token_id_type = op_traits<config_type, core_type, allocation_strategy_types::alloc, data_strategy_types::global,
			final_norm_and_sampling_types::result_token_id, kernel_types::sample_logits, int32_t, output_norm_w_type, output_w_type, temperature_type, top_k_type, top_p_type,
			...
			l_out_trait, last_token_view_trait, final_rms_norm_trait, final_norm_mul_trait, logits_mul_mat_trait, logits_bias_add_trait, rep_penalty_trait, presence_penalty_trait,
			frequency_penalty_trait, vocab_mask_trait, temperature_scale_trait, top_k_filter_trait, top_p_filter_trait, sample_trait>;
