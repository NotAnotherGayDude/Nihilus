...
namespace nihilus {
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::token_embeddings>
		: public core_elem_base<core_types::token_embeddings, core_traits<config_type_new, core_types::token_embeddings>>, public sync_base<config_type_new, core_types::token_embeddings> {
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::mega_attention_apply>
		...
		using k_cache_read_view_trait = kernel_traits<config_type,
			core_trait_dims<mtt::rope_dimension_count, config_type::max_sequence_length, mtt::attention_head_count_kv, 1, 1>, kernel_types::view, kv_store_t, cache_k_type>;
		using v_cache_read_view_trait = kernel_traits<config_type,
			core_trait_dims<config_type::max_sequence_length, mtt::rope_dimension_count, mtt::attention_head_count_kv, 1, 0>, kernel_types::view, kv_store_t, cache_v_type>;
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::mega_ffn>
		...
		using ffn_gate_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, ffn_gate_w_type, ffn_norm_mul_trait>, kernel_types::mul_mat, compute_t,
		...
		using ffn_down_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, ffn_down_w_type, ffn_gate_par_trait>, kernel_types::mul_mat, compute_t,
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::final_norm_and_sampling>
		...
		using presence_penalty_trait = kernel_traits<config_type, get_new_dims_new_3_t<kernel_types::presence_penalty, rep_penalty_trait, token_history_type, presence_penalty_type>,
