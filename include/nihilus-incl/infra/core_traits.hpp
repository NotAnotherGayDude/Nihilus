...
namespace nihilus {
	...
	struct op_traits : public data_mixin<config_type_new, data_strategy_type, typename composite_kernel_type_new::output_type>,
					   public composite_kernel_type_new,
					   public core_elem_base<enum_value_new,
						   op_traits<config_type_new, core_type_new, enum_value_new, kernel_type, data_strategy_type, allocation_strategy_type, composite_kernel_type_new,
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::weights>
		...
		using attn_q_weight_kernel_traits = kernel_traits<config_type,
		...
		using attn_k_weight_kernel_traits = kernel_traits<config_type,
		...
		using attn_v_weight_kernel_traits = kernel_traits<config_type,
			core_trait_dims<model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::n_embd_kv_gqa, 1, 1>, kernel_types::weights, weight_type>;

		using attn_output_weight_kernel_traits = kernel_traits<config_type,
			core_trait_dims<model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::embedding_length, 1, 1>, kernel_types::weights, weight_type>;

		using attn_norm_weight_kernel_traits =
			kernel_traits<config_type, core_trait_dims<model_traits_type<config_type>::embedding_length, 1, 1, 1>, kernel_types::weights, norm_type>;

		using ffn_gate_weight_kernel_traits = kernel_traits<config_type,
		...
		using ffn_up_weight_kernel_traits = kernel_traits<config_type,
			core_trait_dims<model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::feed_forward_length, 1, 1>, kernel_types::weights, weight_type>;

		using ffn_down_weight_kernel_traits = kernel_traits<config_type,
		...
		using token_embd_weight_kernel_traits = kernel_traits<config_type,
		...
		using rope_freqs_weight_kernel_traits =
			kernel_traits<config_type, core_trait_dims<model_traits_type<config_type>::rope_dimension_count / 2, 1, 1, 1>, kernel_types::weights, norm_type>;

		using output_norm_weight_kernel_traits =
			kernel_traits<config_type, core_trait_dims<model_traits_type<config_type>::embedding_length, 1, 1, 1>, kernel_types::weights, norm_type>;

		using output_weight_kernel_traits = kernel_traits<config_type,
			core_trait_dims<model_traits_type<config_type>::embedding_length, model_traits_type<config_type>::vocab_size, 1, 1>, kernel_types::weights, weight_type>;

		using attn_q_weight_type	  = op_traits<config_type, core_types::weights, weight_types::attn_q, composite_kernel_types::none, data_strategy_types::per_block,
				 allocation_strategy_type<config_type::device_type>, attn_q_weight_kernel_traits>;
		using attn_k_weight_type	  = op_traits<config_type, core_types::weights, weight_types::attn_k, composite_kernel_types::none, data_strategy_types::per_block,
				 allocation_strategy_type<config_type::device_type>, attn_k_weight_kernel_traits>;
		using attn_v_weight_type	  = op_traits<config_type, core_types::weights, weight_types::attn_v, composite_kernel_types::none, data_strategy_types::per_block,
				 allocation_strategy_type<config_type::device_type>, attn_v_weight_kernel_traits>;
		using attn_output_weight_type = op_traits<config_type, core_types::weights, weight_types::attn_output, composite_kernel_types::none, data_strategy_types::per_block,
			allocation_strategy_type<config_type::device_type>, attn_output_weight_kernel_traits>;
		using attn_norm_weight_type	  = op_traits<config_type, core_types::weights, weight_types::attn_norm, composite_kernel_types::none, data_strategy_types::per_block,
			  allocation_strategy_type<config_type::device_type>, attn_norm_weight_kernel_traits>;
		using ffn_gate_weight_type	  = op_traits<config_type, core_types::weights, weight_types::ffn_gate, composite_kernel_types::none, data_strategy_types::per_block,
			   allocation_strategy_type<config_type::device_type>, ffn_gate_weight_kernel_traits>;
		using ffn_up_weight_type	  = op_traits<config_type, core_types::weights, weight_types::ffn_up, composite_kernel_types::none, data_strategy_types::per_block,
				 allocation_strategy_type<config_type::device_type>, ffn_up_weight_kernel_traits>;
		using ffn_down_weight_type	  = op_traits<config_type, core_types::weights, weight_types::ffn_down, composite_kernel_types::none, data_strategy_types::per_block,
			   allocation_strategy_type<config_type::device_type>, ffn_down_weight_kernel_traits>;
		using ffn_norm_weight_type	  = op_traits<config_type, core_types::weights, weight_types::ffn_norm, composite_kernel_types::none, data_strategy_types::per_block,
			   allocation_strategy_type<config_type::device_type>, ffn_norm_weight_kernel_traits>;
		using token_embd_weight_type  = op_traits<config_type, core_types::weights, weight_types::token_embd, composite_kernel_types::none, data_strategy_types::global,
			 allocation_strategy_type<config_type::device_type>, token_embd_weight_kernel_traits>;
		using rope_freqs_weight_type  = op_traits<config_type, core_types::weights, weight_types::rope_freqs, composite_kernel_types::none, data_strategy_types::global,
			 allocation_strategy_type<config_type::device_type>, rope_freqs_weight_kernel_traits>;
		using output_norm_weight_type = op_traits<config_type, core_types::weights, weight_types::output_norm, composite_kernel_types::none, data_strategy_types::global,
			allocation_strategy_type<config_type::device_type>, output_norm_weight_kernel_traits>;
		using output_weight_type	  = op_traits<config_type, core_types::weights, weight_types::output, composite_kernel_types::none, data_strategy_types::global,
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::global_inputs>
		...
		using inp_tokens_kernel_traits =
			kernel_traits<config_type, core_trait_dims<config_type::max_sequence_length, 1, 1, 1, 0>, kernel_types::weights, typename kernel_profile_type::input_token_type>;
		using inp_pos_kernel_traits =
			kernel_traits<config_type, core_trait_dims<config_type::max_sequence_length, 1, 1, 1, 0>, kernel_types::weights, typename kernel_profile_type::position_type>;
		using cache_k_kernel_traits =
			kernel_traits<config_type, core_trait_dims<mtt::block_count, config_type::max_sequence_length, mtt::attention_head_count_kv, mtt::rope_dimension_count, 0>,
				kernel_types::weights, typename kernel_profile_type::kv_cache_type>;
		using cache_v_kernel_traits =
			kernel_traits<config_type, core_trait_dims<mtt::block_count, config_type::max_sequence_length, mtt::attention_head_count_kv, mtt::rope_dimension_count, 0>,
				kernel_types::weights, typename kernel_profile_type::kv_cache_type>;
		using kq_mask_kernel_traits =
			kernel_traits<config_type, core_trait_dims<mtt::block_count, mtt::block_count, 1, 1>, kernel_types::weights, typename kernel_profile_type::mask_type>;
		using inp_out_ids_kernel_traits =
			kernel_traits<config_type, core_trait_dims<config_type::max_sequence_length, 1, 1, 1, 0>, kernel_types::weights, typename kernel_profile_type::output_token_type>;

		using temperature_kernel_traits		   = kernel_traits<config_type, core_trait_dims<1, 1, 1, 1>, kernel_types::weights, float>;
		using top_k_kernel_traits			   = kernel_traits<config_type, core_trait_dims<1, 1, 1, 1>, kernel_types::weights, int32_t>;
		using top_p_kernel_traits			   = kernel_traits<config_type, core_trait_dims<1, 1, 1, 1>, kernel_types::weights, float>;
		using repetition_penalty_kernel_traits = kernel_traits<config_type, core_trait_dims<1, 1, 1, 1>, kernel_types::weights, float>;
		using presence_penalty_kernel_traits   = kernel_traits<config_type, core_trait_dims<1, 1, 1, 1>, kernel_types::weights, float>;
		using frequency_penalty_kernel_traits  = kernel_traits<config_type, core_trait_dims<1, 1, 1, 1>, kernel_types::weights, float>;
		using rep_window_kernel_traits		   = kernel_traits<config_type, core_trait_dims<1, 1, 1, 1>, kernel_types::weights, int32_t>;
		using token_history_kernel_traits	   = kernel_traits<config_type, core_trait_dims<config_type::max_sequence_length, 1, 1, 1, 0>, kernel_types::weights, int32_t>;
		using rng_state_kernel_traits		   = kernel_traits<config_type, core_trait_dims<2, 1, 1, 1>, kernel_types::weights, uint64_t>;

		using logits_bias_kernel_traits		   = kernel_traits<config_type, core_trait_dims<mtt::vocab_size, 1, 1, 1>, kernel_types::weights, float>;
		using allowed_vocab_mask_kernel_traits = kernel_traits<config_type, core_trait_dims<mtt::vocab_size, 1, 1, 1>, kernel_types::weights, uint8_t>;

		using cache_k_type	   = op_traits<config_type, core_types::global_inputs, global_input_types::cache_k, composite_kernel_types::none, data_strategy_types::global,
				allocation_strategy_types::alloc, cache_k_kernel_traits>;
		using cache_v_type	   = op_traits<config_type, core_types::global_inputs, global_input_types::cache_v, composite_kernel_types::none, data_strategy_types::global,
				allocation_strategy_types::alloc, cache_v_kernel_traits>;
		using inp_tokens_type  = op_traits<config_type, core_types::global_inputs, global_input_types::inp_tokens, composite_kernel_types::none, data_strategy_types::global,
			 allocation_strategy_types::alloc, inp_tokens_kernel_traits>;
		using inp_pos_type	   = op_traits<config_type, core_types::global_inputs, global_input_types::inp_pos, composite_kernel_types::none, data_strategy_types::global,
				allocation_strategy_types::alloc, inp_pos_kernel_traits>;
		using kq_mask_type	   = op_traits<config_type, core_types::global_inputs, global_input_types::kq_mask, composite_kernel_types::none, data_strategy_types::global,
				allocation_strategy_types::alloc, kq_mask_kernel_traits>;
		using inp_out_ids_type = op_traits<config_type, core_types::global_inputs, global_input_types::inp_out_ids, composite_kernel_types::none, data_strategy_types::global,
			allocation_strategy_types::alloc, inp_out_ids_kernel_traits>;

		using temperature_type = op_traits<config_type, core_types::global_inputs, global_input_types::temperature, composite_kernel_types::none, data_strategy_types::global,
			allocation_strategy_types::alloc, temperature_kernel_traits>;
		using top_k_type	   = op_traits<config_type, core_types::global_inputs, global_input_types::top_k, composite_kernel_types::none, data_strategy_types::global,
				  allocation_strategy_types::alloc, top_k_kernel_traits>;
		using top_p_type	   = op_traits<config_type, core_types::global_inputs, global_input_types::top_p, composite_kernel_types::none, data_strategy_types::global,
				  allocation_strategy_types::alloc, top_p_kernel_traits>;
		using repetition_penalty_type = op_traits<config_type, core_types::global_inputs, global_input_types::repetition_penalty, composite_kernel_types::none,
			data_strategy_types::global, allocation_strategy_types::alloc, repetition_penalty_kernel_traits>;
		using presence_penalty_type	  = op_traits<config_type, core_types::global_inputs, global_input_types::presence_penalty, composite_kernel_types::none,
			  data_strategy_types::global, allocation_strategy_types::alloc, presence_penalty_kernel_traits>;
		using frequency_penalty_type  = op_traits<config_type, core_types::global_inputs, global_input_types::frequency_penalty, composite_kernel_types::none,
			 data_strategy_types::global, allocation_strategy_types::alloc, frequency_penalty_kernel_traits>;
		using rep_window_type		  = op_traits<config_type, core_types::global_inputs, global_input_types::rep_window, composite_kernel_types::none, data_strategy_types::global,
					allocation_strategy_types::alloc, rep_window_kernel_traits>;
		using token_history_type = op_traits<config_type, core_types::global_inputs, global_input_types::token_history, composite_kernel_types::none, data_strategy_types::global,
			allocation_strategy_types::alloc, token_history_kernel_traits>;
		using rng_state_type	 = op_traits<config_type, core_types::global_inputs, global_input_types::rng_state, composite_kernel_types::none, data_strategy_types::global,
				allocation_strategy_types::alloc, rng_state_kernel_traits>;

		using logits_bias_type = op_traits<config_type, core_types::global_inputs, global_input_types::logits_bias, composite_kernel_types::none, data_strategy_types::global,
			allocation_strategy_types::alloc, logits_bias_kernel_traits>;
		using allowed_vocab_mask_type = op_traits<config_type, core_types::global_inputs, global_input_types::allowed_vocab_mask, composite_kernel_types::none,
	...
	template<batched_processing_config_types config_type_new> struct core_traits<config_type_new, core_types::global_inputs>
		...
		using inp_tokens_kernel_traits	= kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, config_type::max_sequence_length, 1, 1, 0, 1>,
			 kernel_types::weights, typename kernel_profile_type::input_token_type>;
		using inp_pos_kernel_traits		= kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, config_type::max_sequence_length, 1, 1, 0, 1>,
				kernel_types::weights, typename kernel_profile_type::position_type>;
		using cache_k_kernel_traits		= kernel_traits<config_type,
				...
				kernel_types::weights, typename kernel_profile_type::kv_cache_type>;
		using cache_v_kernel_traits		= kernel_traits<config_type,
				batched_core_trait_dims<config_type::batch_size * mtt::block_count, config_type::max_sequence_length, mtt::attention_head_count_kv, mtt::rope_dimension_count, 0, 1>,
				kernel_types::weights, typename kernel_profile_type::kv_cache_type>;
		using kq_mask_kernel_traits		= kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, mtt::block_count, mtt::block_count, 1, 0, 5>,
				kernel_types::weights, typename kernel_profile_type::mask_type>;
		using inp_out_ids_kernel_traits = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, config_type::max_sequence_length, 1, 1, 0, 1>,
			kernel_types::weights, typename kernel_profile_type::output_token_type>;

		using temperature_kernel_traits		   = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, 1, 1, 1, 0, 5>, kernel_types::weights, float>;
		using top_k_kernel_traits			   = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, 1, 1, 1, 0, 5>, kernel_types::weights, int32_t>;
		using top_p_kernel_traits			   = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, 1, 1, 1, 0, 5>, kernel_types::weights, float>;
		using repetition_penalty_kernel_traits = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, 1, 1, 1, 0, 5>, kernel_types::weights, float>;
		using presence_penalty_kernel_traits   = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, 1, 1, 1, 0, 5>, kernel_types::weights, float>;
		using frequency_penalty_kernel_traits  = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, 1, 1, 1, 0, 5>, kernel_types::weights, float>;
		using rep_window_kernel_traits		   = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, 1, 1, 1, 0, 5>, kernel_types::weights, int32_t>;
		using token_history_kernel_traits =
			kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, config_type::max_sequence_length, 1, 1, 0, 1>, kernel_types::weights, int32_t>;
		using rng_state_kernel_traits = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, 2, 1, 1, 0, 5>, kernel_types::weights, uint64_t>;

		using logits_bias_kernel_traits = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, mtt::vocab_size, 1, 1, 0, 5>, kernel_types::weights, float>;
		using allowed_vocab_mask_kernel_traits =
			kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, mtt::vocab_size, 1, 1, 0, 5>, kernel_types::weights, uint8_t>;
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::token_embeddings>
		...
		using input_embedding_kernel_traits = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::get_rows, input_01_type, input_02_type>, kernel_types::get_rows,
			output_type, input_01_type, input_02_type>;

		using token_embeddings_type = op_traits<config_type, core_types::token_embeddings, token_embeddings_types::get_rows, composite_kernel_types::get_rows,
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::mega_qkv_prep_and_cache_publish>
		...
		using rms_norm_trait = kernel_traits<config_type, get_new_dims_new_1_t<kernel_types::rms_norm, inp_embd_type>, kernel_types::rms_norm, compute_t, inp_embd_type>;

		using mul_trait =
			kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul, rms_norm_trait, attn_norm_w_type>, kernel_types::mul, compute_t, rms_norm_trait, attn_norm_w_type>;

		using q_mul_mat_trait =
			kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, attn_q_w_type, mul_trait>, kernel_types::mul_mat, compute_t, attn_q_w_type, mul_trait>;

		using q_reshape_trait = kernel_traits<config_type, core_trait_dims<mtt::rope_dimension_count, mtt::attention_head_count, config_type::max_sequence_length, 1, 2>,
			kernel_types::reshape, compute_t, q_mul_mat_trait>;

		using q_rope_trait = kernel_traits<config_type, get_new_dims_new_3_t<kernel_types::rope, q_reshape_trait, inp_pos_type, rope_freqs_type>, kernel_types::rope, compute_t,
			q_reshape_trait, inp_pos_type, rope_freqs_type>;

		using k_mul_mat_trait =
			kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, attn_k_w_type, mul_trait>, kernel_types::mul_mat, compute_t, attn_k_w_type, mul_trait>;

		using k_reshape_trait = kernel_traits<config_type, core_trait_dims<mtt::rope_dimension_count, mtt::attention_head_count_kv, config_type::max_sequence_length, 1, 2>,
			kernel_types::reshape, compute_t, k_mul_mat_trait>;

		using k_rope_trait = kernel_traits<config_type, get_new_dims_new_3_t<kernel_types::rope, k_reshape_trait, inp_pos_type, rope_freqs_type>, kernel_types::rope, compute_t,
			k_reshape_trait, inp_pos_type, rope_freqs_type>;

		using v_mul_mat_trait =
			kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, attn_v_w_type, mul_trait>, kernel_types::mul_mat, compute_t, attn_v_w_type, mul_trait>;

		using v_transpose_trait =
			kernel_traits<config_type, core_trait_dims<config_type::max_sequence_length, mtt::n_embd_kv_gqa, 1, 1, 0>, kernel_types::transpose, compute_t, v_mul_mat_trait>;

		using k_cache_window_view_trait = kernel_traits<config_type,
		...
		using v_cache_window_view_trait = kernel_traits<config_type,
		...
		using k_cache_store_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::copy, k_rope_trait, k_cache_window_view_trait>, kernel_types::copy, kv_store_t,
			k_rope_trait, k_cache_window_view_trait>;

		using v_cache_store_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::copy, v_transpose_trait, v_cache_window_view_trait>, kernel_types::copy,
		...
		using q_out_type = op_traits<config_type, core_types::mega_qkv_prep_and_cache_publish, mega_qkv_prep_and_cache_publish_types::q_out,
	...
	template<batched_processing_config_types config_type_new> struct core_traits<config_type_new, core_types::mega_qkv_prep_and_cache_publish>
		...
		using q_reshape_trait = kernel_traits<config_type,
		...
		using k_reshape_trait = kernel_traits<config_type,
		...
		using v_transpose_trait = kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, config_type::max_sequence_length, mtt::n_embd_kv_gqa, 1, 0, 1>,
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::mega_attention_apply>
		...
		using k_cache_read_view_trait = kernel_traits<config_type, core_trait_dims<mtt::rope_dimension_count, config_type::max_sequence_length, mtt::attention_head_count_kv, 1, 1>,
			kernel_types::view, kv_store_t, cache_k_type>;
		using v_cache_read_view_trait = kernel_traits<config_type, core_trait_dims<config_type::max_sequence_length, mtt::rope_dimension_count, mtt::attention_head_count_kv, 1, 0>,
			kernel_types::view, kv_store_t, cache_v_type>;

		using q_input_trait = kernel_traits<config_type, q_rope_input_dims, kernel_types::weights, compute_t>;

		using kq_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, k_cache_read_view_trait, q_input_trait>, kernel_types::mul_mat, compute_t,
			k_cache_read_view_trait, q_input_trait>;

		using softmax_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::softmax, kq_mul_mat_trait, kq_mask_type>, kernel_types::softmax, compute_t,
			kq_mul_mat_trait, kq_mask_type>;

		using kqv_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, v_cache_read_view_trait, softmax_trait>, kernel_types::mul_mat, compute_t,
			v_cache_read_view_trait, softmax_trait>;

		using merge_permute_trait = kernel_traits<config_type, core_trait_dims<mtt::rope_dimension_count, mtt::attention_head_count, config_type::max_sequence_length, 1, 2>,
			kernel_types::permute, compute_t, kqv_mul_mat_trait>;

		using cont_trait =
			kernel_traits<config_type, core_trait_dims<mtt::embedding_length, config_type::max_sequence_length, 1, 1, 1>, kernel_types::cont, compute_t, merge_permute_trait>;

		using attn_out_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, attn_output_w_type, cont_trait>, kernel_types::mul_mat, compute_t,
			attn_output_w_type, cont_trait>;

		using residual_add_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::add, attn_out_mul_mat_trait, inp_embd_type>, kernel_types::add, compute_t,
		...
		using ffn_inp_type = op_traits<config_type, core_types::mega_attention_apply, mega_attention_apply_types::ffn_inp, composite_kernel_types::mega_attention_apply,
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::mega_ffn>
		...
		using ffn_inp_trait = kernel_traits<config_type, ffn_inp_input_dims, kernel_types::weights, compute_t>;

		using ffn_rms_norm_trait = kernel_traits<config_type, get_new_dims_new_1_t<kernel_types::rms_norm, ffn_inp_trait>, kernel_types::rms_norm, compute_t, ffn_inp_trait>;

		using ffn_norm_mul_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul, ffn_rms_norm_trait, ffn_norm_w_type>, kernel_types::mul, compute_t,
			ffn_rms_norm_trait, ffn_norm_w_type>;

		using ffn_gate_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, ffn_gate_w_type, ffn_norm_mul_trait>, kernel_types::mul_mat,
			compute_t, ffn_gate_w_type, ffn_norm_mul_trait>;

		using ffn_up_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, ffn_up_w_type, ffn_norm_mul_trait>, kernel_types::mul_mat, compute_t,
			ffn_up_w_type, ffn_norm_mul_trait>;

		using ffn_silu_trait = kernel_traits<config_type, get_new_dims_new_1_t<kernel_types::silu, ffn_gate_mul_mat_trait>, kernel_types::silu, compute_t, ffn_gate_mul_mat_trait>;

		using ffn_gate_par_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul, ffn_silu_trait, ffn_up_mul_mat_trait>, kernel_types::mul, compute_t,
			ffn_silu_trait, ffn_up_mul_mat_trait>;

		using ffn_down_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, ffn_down_w_type, ffn_gate_par_trait>, kernel_types::mul_mat,
			compute_t, ffn_down_w_type, ffn_gate_par_trait>;

		using ffn_residual_add_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::add, ffn_down_mul_mat_trait, ffn_inp_trait>, kernel_types::add, compute_t,
		...
		using l_out_type = op_traits<config_type, core_types::mega_ffn, mega_ffn_types::l_out, composite_kernel_types::mega_ffn, data_strategy_types::global,
	...
	template<typename config_type_new> struct core_traits<config_type_new, core_types::final_norm_and_sampling>
		...
		using l_out_trait = kernel_traits<config_type, l_out_input_dims, kernel_types::weights, compute_t>;

		using last_token_view_trait = kernel_traits<config_type, core_trait_dims<mtt::embedding_length, 1, 1, 1, 0>, kernel_types::view, compute_t, l_out_trait>;

		using final_rms_norm_trait =
			kernel_traits<config_type, get_new_dims_new_1_t<kernel_types::rms_norm, last_token_view_trait>, kernel_types::rms_norm, compute_t, last_token_view_trait>;

		using final_norm_mul_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul, final_rms_norm_trait, output_norm_w_type>, kernel_types::mul, compute_t,
			final_rms_norm_trait, output_norm_w_type>;

		using logits_mul_mat_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::mul_mat, output_w_type, final_norm_mul_trait>, kernel_types::mul_mat, compute_t,
			output_w_type, final_norm_mul_trait>;

		using logits_bias_add_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::add, logits_mul_mat_trait, logits_bias_type>, kernel_types::add, compute_t,
			logits_mul_mat_trait, logits_bias_type>;

		using rep_penalty_trait =
			kernel_traits<config_type, get_new_dims_new_3_t<kernel_types::repetition_penalty, logits_bias_add_trait, token_history_type, repetition_penalty_type>,
		...
		using presence_penalty_trait =
			kernel_traits<config_type, get_new_dims_new_3_t<kernel_types::presence_penalty, rep_penalty_trait, token_history_type, presence_penalty_type>,
		...
		using frequency_penalty_trait =
			kernel_traits<config_type, get_new_dims_new_3_t<kernel_types::frequency_penalty, presence_penalty_trait, token_history_type, frequency_penalty_type>,
				kernel_types::frequency_penalty, compute_t, presence_penalty_trait, token_history_type, frequency_penalty_type>;

		using vocab_mask_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::vocab_mask, frequency_penalty_trait, allowed_vocab_mask_type>,
			kernel_types::vocab_mask, compute_t, frequency_penalty_trait, allowed_vocab_mask_type>;

		using temperature_scale_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::temperature_scale, vocab_mask_trait, temperature_type>,
			kernel_types::temperature_scale, compute_t, vocab_mask_trait, temperature_type>;

		using top_k_filter_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::top_k_filter, temperature_scale_trait, top_k_type>, kernel_types::top_k_filter,
			compute_t, temperature_scale_trait, top_k_type>;

		using top_p_filter_trait = kernel_traits<config_type, get_new_dims_new_2_t<kernel_types::top_p_filter, top_k_filter_trait, top_p_type>, kernel_types::top_p_filter,
			compute_t, top_k_filter_trait, top_p_type>;

		using sample_trait = kernel_traits<config_type, core_trait_dims<1, 1, 1, 1, 0>, kernel_types::sample_logits, int32_t, top_p_filter_trait, rng_state_type>;
		...
		using result_token_id_type = op_traits<config_type, core_types::final_norm_and_sampling, final_norm_and_sampling_types::result_token_id,
	...
	template<batched_processing_config_types config_type_new> struct core_traits<config_type_new, core_types::final_norm_and_sampling>
		...
		using last_token_view_trait =
			kernel_traits<config_type, batched_core_trait_dims<config_type::batch_size, mtt::embedding_length, 1, 1, 0, 1>, kernel_types::view, compute_t, l_out_trait>;
		...
		using sample_trait = kernel_traits<config_type, batched_core_trait_dims<1, 1, 1, 1, 0, 5>, kernel_types::sample_logits, int32_t, top_p_filter_trait, rng_state_type>;
	...
	template<typename config_type_new, auto kernel_type> struct get_adjacent_value {
		...
		using core_bases_type  = typename thread_pool<config_type_new>::core_bases_type;
