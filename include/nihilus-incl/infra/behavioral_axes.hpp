...
namespace nihilus {
	...
	struct memory_plan {
		mutable array<core_traits_memory_footprint, core_types::count> footprints{};
		mutable uint64_t currently_allocated_bytes{};
		mutable uint64_t peak_allocated_bytes{};
	};
