...
namespace nihilus {
	...
	template<kernel_types kernel_type, typename core_traits01, typename core_traits02, typename core_traits03, typename core_traits04, typename core_traits05,
		typename... operand_types>
	struct get_new_dims_5;

	template<kernel_types kernel_type, typename core_traits01, typename core_traits02, typename core_traits03, typename core_traits04, typename core_traits05,
		typename core_traits06, typename... operand_types>
	struct get_new_dims_6;
	...
	struct get_new_dims_3<kernel_type, core_traits01, core_traits02, core_traits03, dimension_type...> {
		...
		static constexpr auto get_new_dims_fn() {
			if constexpr (kernel_type == kernel_types::fused_qkv_rope) {
				return core_trait_dims<dims01[0], dims01[1], dims01[2], dims01[3], (dimension_type::dimension, ...)>{};
			} else if constexpr (kernel_type == kernel_types::fused_attn_out) {
				return core_trait_dims<dims01[0], dims01[1], dims01[2], dims01[3], (dimension_type::dimension, ...)>{};
			} else if constexpr (kernel_type == kernel_types::fused_final_proj) {
				return core_trait_dims<dims03[0], dims03[1], dims03[2], dims03[3], (dimension_type::dimension, ...)>{};
			} else {
	...
	template<kernel_types kernel_type, core_traits_types core_traits01, core_traits_types core_traits02, core_traits_types core_traits03>
	struct get_new_dims_3<kernel_type, core_traits01, core_traits02, core_traits03> {
		using dim_traits01			 = typename core_traits01::core_traits_dims_type;
		using dim_traits02			 = typename core_traits02::core_traits_dims_type;
		using dim_traits03			 = typename core_traits03::core_traits_dims_type;
		static constexpr auto dims01 = dim_traits01::get_array();
		...
		static constexpr auto get_new_dims_fn() {
			if constexpr (kernel_type == kernel_types::fused_qkv_rope) {
				...
				return core_trait_dims<dims03[0], dims03[1], dims03[2], dims03[3]>{};
			} else {
				static_assert(static_assert_printer<false, get_new_dims_errors::unknown_kernel_type, core_traits01, core_traits02, core_traits03>::impl);
			}
		}
	...
	template<kernel_types kernel_type, core_traits_types core_traits01, core_traits_types core_traits02> struct get_new_dims_2<kernel_type, core_traits01, core_traits02> {
		...
		static constexpr auto get_new_dims_fn() {
			if constexpr (kernel_type == kernel_types::embedding_lookup) {
				return core_trait_dims<dims01[1], dims02[0], dims01[2], dims01[3]>{};
			}  else if constexpr (kernel_type == kernel_types::fused_attention) {
				return core_trait_dims<dims01[0] / 3, dims01[1], dims01[2], dims01[3]>{};
			} else if constexpr (kernel_type == kernel_types::fused_attn_out) {
				return core_trait_dims<dims01[0], dims01[1], dims01[2], dims01[3]>{};
			} else if constexpr (kernel_type == kernel_types::fused_swiglu) {
				return core_trait_dims<dims01[0], dims01[1], dims01[2], dims01[3]>{};
			} else if constexpr (kernel_type == kernel_types::fused_final_proj) {
				return core_trait_dims<dims02[0], dims01[1], dims01[2], dims01[3]>{};
			} else {
	...
	struct get_new_dims_2<kernel_type, core_traits01, core_traits02, dimension_type...> {
		...
		static constexpr auto get_new_dims_fn() {
			if constexpr (kernel_type == kernel_types::embedding_lookup) {
				...
				return core_trait_dims<dims01[0] / 3, dims01[1], dims01[2], dims01[3], (dimension_type::dimension, ...)>{};
			} else if constexpr (kernel_type == kernel_types::fused_attn_out) {
				return core_trait_dims<dims01[0], dims01[1], dims01[2], dims01[3], (dimension_type::dimension, ...)>{};
			} else if constexpr (kernel_type == kernel_types::fused_swiglu) {
				return core_trait_dims<dims01[0], dims01[1], dims01[2], dims01[3], (dimension_type::dimension, ...)>{};
			} else if constexpr (kernel_type == kernel_types::fused_final_proj) {
				return core_trait_dims<dims02[0], dims01[1], dims01[2], dims01[3], (dimension_type::dimension, ...)>{};
			} else {
	...
	template<kernel_types kernel_type, core_traits_types core_traits01, core_traits_types core_traits02, core_traits_types core_traits03, core_traits_types core_traits04,
		core_traits_types core_traits05>
	struct get_new_dims_5<kernel_type, core_traits01, core_traits02, core_traits03, core_traits04, core_traits05> {
		using dim_traits01			 = typename core_traits01::core_traits_dims_type;
		using dim_traits02			 = typename core_traits02::core_traits_dims_type;
		using dim_traits03			 = typename core_traits03::core_traits_dims_type;
		using dim_traits04			 = typename core_traits04::core_traits_dims_type;
		using dim_traits05			 = typename core_traits05::core_traits_dims_type;
		static constexpr auto dims01 = dim_traits01::get_array();
		static constexpr auto dims02 = dim_traits02::get_array();
		static constexpr auto dims03 = dim_traits03::get_array();
		static constexpr auto dims04 = dim_traits04::get_array();
		static constexpr auto dims05 = dim_traits05::get_array();

		static constexpr auto get_new_dims_fn() {
			if constexpr (kernel_type == kernel_types::fused_swiglu) {
				return core_trait_dims<dims01[0], dims01[1], dims01[2], dims01[3]>{};
			} else {
				static_assert(
					static_assert_printer<false, get_new_dims_errors::unknown_kernel_type, core_traits01, core_traits02, core_traits03, core_traits04, core_traits05>::impl);
			}
		}
	...
	template<kernel_types kernel_type, core_traits_types core_traits01, core_traits_types core_traits02, core_traits_types core_traits03, core_traits_types core_traits04,
		core_traits_types core_traits05, runtime_dims_t... dimension_type>
	struct get_new_dims_5<kernel_type, core_traits01, core_traits02, core_traits03, core_traits04, core_traits05, dimension_type...> {
		using dim_traits01			 = typename core_traits01::core_traits_dims_type;
		using dim_traits02			 = typename core_traits02::core_traits_dims_type;
		using dim_traits03			 = typename core_traits03::core_traits_dims_type;
		using dim_traits04			 = typename core_traits04::core_traits_dims_type;
		...
		static constexpr auto get_new_dims_fn() {
			if constexpr (kernel_type == kernel_types::fused_swiglu) {
				...
				static_assert(static_assert_printer<false, get_new_dims_errors::unknown_kernel_type, core_traits01, core_traits02, core_traits03, core_traits04, core_traits05,
					dimension_type...>::impl);
			}
		}
	...
	template<kernel_types kernel_type, core_traits_types core_traits01, core_traits_types core_traits02, core_traits_types core_traits03, core_traits_types core_traits04,
		core_traits_types core_traits05, core_traits_types core_traits06, runtime_dims_t... dimension_type>
	struct get_new_dims_6<kernel_type, core_traits01, core_traits02, core_traits03, core_traits04, core_traits05, core_traits06, dimension_type...> {
		using dim_traits01 = typename core_traits01::core_traits_dims_type;
		using dim_traits02 = typename core_traits02::core_traits_dims_type;
		using dim_traits03 = typename core_traits03::core_traits_dims_type;
		using dim_traits04 = typename core_traits04::core_traits_dims_type;
		using dim_traits05 = typename core_traits05::core_traits_dims_type;
		using dim_traits06 = typename core_traits06::core_traits_dims_type;
		...
		static constexpr auto dims04 = dim_traits04::get_array();
		static constexpr auto dims05 = dim_traits05::get_array();
		static constexpr auto dims06 = dim_traits06::get_array();
		...
		static constexpr auto get_new_dims_fn() {
			if constexpr (kernel_type == kernel_types::fused_qkv_rope) {
				...
				static_assert(static_assert_printer<false, get_new_dims_errors::unknown_kernel_type, core_traits01, core_traits02, core_traits03, core_traits04, core_traits05,
					core_traits06, dimension_type...>::impl);
			}
		}
	...
	template<model_config config, kernel_types kernel_type, op_types op_type01, op_types op_type02, op_types op_type03, op_types op_type04, op_types op_type05,
		typename... dimensions_type>
	using get_new_dims_5_t = typename get_new_dims_5<kernel_type, core_traits<config, op_type01>, core_traits<config, op_type02>, core_traits<config, op_type03>,
		core_traits<config, op_type04>, core_traits<config, op_type05>, dimensions_type...>::type;

	template<model_config config, kernel_types kernel_type, op_types op_type01, op_types op_type02, op_types op_type03, op_types op_type04, op_types op_type05, op_types op_type06,
		typename... dimensions_type>
	using get_new_dims_6_t = typename get_new_dims_6<kernel_type, core_traits<config, op_type01>, core_traits<config, op_type02>, core_traits<config, op_type03>,
		core_traits<config, op_type04>, core_traits<config, op_type05>, core_traits<config, op_type06>, dimensions_type...>::type;
	...
	template<typename input_01_type, typename input_02_type> struct kernel_traits_new<kernel_types::embedding_lookup, input_01_type, input_02_type>
		: public kernel_base<kernel_types::embedding_lookup, input_01_type, input_02_type> {
		using base_type				 = kernel_base<kernel_types::embedding_lookup, input_01_type, input_02_type>;
