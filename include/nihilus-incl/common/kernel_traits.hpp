...
namespace nihilus {
	...
	template<size_t... runtime_mask> constexpr uint64_t get_runtime_mask() {
	...
	concept preserved_dimensions_kernel_types =
		detail::remove_cvref_t<value_type>::kernel_type == kernel_types::add || detail::remove_cvref_t<value_type>::kernel_type == kernel_types::mul ||
		detail::remove_cvref_t<value_type>::kernel_type == kernel_types::sub || detail::remove_cvref_t<value_type>::kernel_type == kernel_types::rms_norm ||
		detail::remove_cvref_t<value_type>::kernel_type == kernel_types::silu || detail::remove_cvref_t<value_type>::kernel_type == kernel_types::softmax ||
		detail::remove_cvref_t<value_type>::kernel_type == kernel_types::rope || detail::remove_cvref_t<value_type>::kernel_type == kernel_types::copy ||
		...
		detail::remove_cvref_t<value_type>::kernel_type == kernel_types::repetition_penalty || detail::remove_cvref_t<value_type>::kernel_type == kernel_types::presence_penalty ||
		detail::remove_cvref_t<value_type>::kernel_type == kernel_types::frequency_penalty || detail::remove_cvref_t<value_type>::kernel_type == kernel_types::temperature_scale ||
		detail::remove_cvref_t<value_type>::kernel_type == kernel_types::vocab_mask || detail::remove_cvref_t<value_type>::kernel_type == kernel_types::div;
	...
	template<typename kernel_type, typename... dims_types> struct dim_traits;

	template<kernel_dims_types input_dims_01> struct dim_traits<kernel_types_type<kernel_types::weights>, input_dims_01> {
	...
	template<preserved_dimensions_kernel_types kernel_type, kernel_dims_types... dims_types> struct dim_traits<kernel_type, dims_types...> {
	...
	template<kernel_dims_types output_dims, kernel_dims_types input_dims> struct dim_traits<kernel_types_type<kernel_types::reshape>, output_dims, input_dims> {
	...
	template<kernel_dims_types output_dims, kernel_dims_types input_dims> struct dim_traits<kernel_types_type<kernel_types::view>, output_dims, input_dims> {
		static constexpr auto dims01			  = input_dims::dims;
		static constexpr auto dims02			  = output_dims::dims;
		static constexpr uint64_t input_elements  = compute_elements(dims01);
		static constexpr uint64_t output_elements = compute_elements(dims02);
	...
	template<kernel_dims_types output_dims, kernel_dims_types input_dims> struct dim_traits<kernel_types_type<kernel_types::transpose>, output_dims, input_dims> {
		static constexpr auto dims01			  = input_dims::dims;
		static constexpr auto dims02			  = output_dims::dims;
		static constexpr uint64_t input_elements  = compute_elements(dims01);
		static constexpr uint64_t output_elements = compute_elements(dims02);
	...
	template<kernel_dims_types output_dims, kernel_dims_types input_dims> struct dim_traits<kernel_types_type<kernel_types::permute>, output_dims, input_dims> {
		static constexpr auto dims01			  = input_dims::dims;
		static constexpr auto dims02			  = output_dims::dims;
		static constexpr uint64_t input_elements  = compute_elements(dims01);
		static constexpr uint64_t output_elements = compute_elements(dims02);
	...
	template<kernel_dims_types input_dims_01, kernel_dims_types input_dims_02> struct dim_traits<kernel_types_type<kernel_types::mul_mat>, input_dims_01, input_dims_02> {
		static constexpr auto dims01 = input_dims_01::dims;
		static constexpr auto dims02 = input_dims_02::dims;
		using dims_type				 = kernel_dims<input_dims_02::runtime_mask, dims02[0], dims01[1], dims02[2], dims01[3]>;
	};

	template<kernel_dims_types input_dims_01, kernel_dims_types input_dims_02> struct dim_traits<kernel_types_type<kernel_types::get_rows>, input_dims_01, input_dims_02> {
		static constexpr auto dims01 = input_dims_01::dims;
		static constexpr auto dims02 = input_dims_02::dims;
		using dims_type				 = kernel_dims<5, dims02[0], dims01[0], dims02[1], dims01[3]>;
	};

	template<kernel_dims_types output_dims, kernel_dims_types input_dims> struct dim_traits<kernel_types_type<kernel_types::cont>, output_dims, input_dims> {
		static constexpr auto dims01			  = input_dims::dims;
		static constexpr auto dims02			  = output_dims::dims;
		static constexpr uint64_t input_elements  = compute_elements(dims01);
		static constexpr uint64_t output_elements = compute_elements(dims02);
	...
	template<kernel_dims_types output_dims, kernel_dims_types input_dims_01, kernel_dims_types input_dims_02>
	struct dim_traits<kernel_types_type<kernel_types::sample_logits>, output_dims, input_dims_01, input_dims_02> {
		using dims_type = kernel_dims<output_dims::runtime_mask, output_dims::dims[0], output_dims::dims[1], output_dims::dims[2], output_dims::dims[3]>;
	};
	...
	template<kernel_types_types kernel_type_new, typename... input_types_new> struct kernel_traits;

	template<weights_kernel_types kernel_type_new, typename output_type_new, kernel_dims_types dims_type_new> struct kernel_traits<kernel_type_new, output_type_new, dims_type_new>
		: public dim_traits<kernel_type_new, dims_type_new>::dims_type {
		static constexpr kernel_types kernel_type{ kernel_type_new::kernel_type };
		using output_type = output_type_new;
		static constexpr bool raw_kernel_type{ false };
	};

	template<kernel_types_types kernel_type_new, typename output_type_new, kernel_traits_types input_type_01> struct kernel_traits<kernel_type_new, output_type_new, input_type_01>
		: public dim_traits<kernel_type_new, input_type_01>::dims_type {
		static constexpr kernel_types kernel_type{ kernel_type_new::kernel_type };
		using output_type = output_type_new;
		static constexpr bool raw_kernel_type{ false };
	};

	template<kernel_types_types kernel_type_new, typename output_type_new, typename input_type_01, kernel_traits_types input_type_02>
	struct kernel_traits<kernel_type_new, output_type_new, input_type_01, input_type_02> : public dim_traits<kernel_type_new, input_type_01, input_type_02>::dims_type {
		static constexpr kernel_types kernel_type{ kernel_type_new::kernel_type };
		using output_type = output_type_new;
		static constexpr bool raw_kernel_type{ false };
	};

	template<kernel_types_types kernel_type_new, typename output_type_new, typename input_type_01, kernel_traits_types input_type_02, kernel_traits_types input_type_03>
	struct kernel_traits<kernel_type_new, output_type_new, input_type_01, input_type_02, input_type_03>
		: public dim_traits<kernel_type_new, input_type_01, input_type_02, input_type_03>::dims_type {
		static constexpr kernel_types kernel_type{ kernel_type_new::kernel_type };
		using output_type = output_type_new;
		static constexpr bool raw_kernel_type{ false };
	};
	...
	template<typename config_type_new, core_types core_type_new, allocation_strategy_types allocation_strategy_type, data_strategy_types data_strategy_type,
		enum_types auto enum_value_new, kernel_types kernel_type_new, typename output_type_new, typename... sub_kernel_types>
