...
namespace nihilus {
	...
	template<typename config_type_new, enum_types auto enum_value_new, typename enum_type = decltype(enum_value_new)> struct sub_kernel_traits;

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::attn_q>
		: public core_elem_base<weight_types::attn_q, sub_kernel_traits<config_type_new, weight_types::attn_q>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0,
			  get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, model_traits_type<config_type_new>::embedding_length, 1ull, 1ull)>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::attn_k>
		: public core_elem_base<weight_types::attn_k, sub_kernel_traits<config_type_new, weight_types::attn_k>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0,
			  get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, model_traits_type<config_type_new>::n_embd_kv_gqa, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::attn_k };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::attn_v>
		: public core_elem_base<weight_types::attn_v, sub_kernel_traits<config_type_new, weight_types::attn_v>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0,
			  get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, model_traits_type<config_type_new>::n_embd_kv_gqa, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::attn_output>
		: public core_elem_base<weight_types::attn_output, sub_kernel_traits<config_type_new, weight_types::attn_output>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0,
			  get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, model_traits_type<config_type_new>::embedding_length, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::attn_norm>
		: public core_elem_base<weight_types::attn_norm, sub_kernel_traits<config_type_new, weight_types::attn_norm>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::norm_type;
		using dims_type	  = kernel_dims_new<0, get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, 1ull, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::attn_norm };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::ffn_gate>
		: public core_elem_base<weight_types::ffn_gate, sub_kernel_traits<config_type_new, weight_types::ffn_gate>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0,
			  get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, model_traits_type<config_type_new>::feed_forward_length, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::ffn_gate };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::ffn_up>
		: public core_elem_base<weight_types::ffn_up, sub_kernel_traits<config_type_new, weight_types::ffn_up>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0,
			  get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, model_traits_type<config_type_new>::feed_forward_length, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::ffn_down>
		: public core_elem_base<weight_types::ffn_down, sub_kernel_traits<config_type_new, weight_types::ffn_down>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0,
			  get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::feed_forward_length, model_traits_type<config_type_new>::embedding_length, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::ffn_down };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::ffn_norm>
		: public core_elem_base<weight_types::ffn_norm, sub_kernel_traits<config_type_new, weight_types::ffn_norm>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::norm_type;
		using dims_type	  = kernel_dims_new<0, get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, 1ull, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::token_embd>
		: public core_elem_base<weight_types::token_embd, sub_kernel_traits<config_type_new, weight_types::token_embd>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type =
			kernel_dims_new<0, get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, model_traits_type<config_type_new>::vocab_size, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::rope_freqs>
		: public core_elem_base<weight_types::rope_freqs, sub_kernel_traits<config_type_new, weight_types::rope_freqs>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<0, get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::rope_dimension_count, 1ull, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ weight_types::rope_freqs };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::output_norm>
		: public core_elem_base<weight_types::output_norm, sub_kernel_traits<config_type_new, weight_types::output_norm>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::norm_type;
		using dims_type	  = kernel_dims_new<0, get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, 1ull, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, weight_types::output>
		: public core_elem_base<weight_types::output, sub_kernel_traits<config_type_new, weight_types::output>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type =
			kernel_dims_new<0, get_shifted_dimensions<false, 0>(model_traits_type<config_type_new>::embedding_length, model_traits_type<config_type_new>::vocab_size, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::inp_tokens>
		: public core_elem_base<global_input_types::inp_tokens, sub_kernel_traits<config_type_new, global_input_types::inp_tokens>> {
		...
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(config_type_new::max_sequence_length, 1ull, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::inp_tokens };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::inp_pos>
		: public core_elem_base<global_input_types::inp_pos, sub_kernel_traits<config_type_new, global_input_types::inp_pos>> {
		...
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(uint64_t{ 1ull }, 1ull, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::inp_pos };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::cache_k>
		: public core_elem_base<global_input_types::cache_k, sub_kernel_traits<config_type_new, global_input_types::cache_k>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(config_type_new::max_sequence_length,
				  model_traits_type<config_type_new>::n_embd_kv_gqa, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ global_input_types::cache_k };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::cache_v>
		: public core_elem_base<global_input_types::cache_v, sub_kernel_traits<config_type_new, global_input_types::cache_v>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(config_type_new::max_sequence_length,
				  model_traits_type<config_type_new>::n_embd_kv_gqa, 1ull, 1ull)>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::kq_mask>
		: public core_elem_base<global_input_types::kq_mask, sub_kernel_traits<config_type_new, global_input_types::kq_mask>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::mask_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(32ull, 32ull, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::kq_mask };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::inp_out_ids>
		: public core_elem_base<global_input_types::inp_out_ids, sub_kernel_traits<config_type_new, global_input_types::inp_out_ids>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1ull)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::inp_out_ids };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::temperature>
		: public core_elem_base<global_input_types::temperature, sub_kernel_traits<config_type_new, global_input_types::temperature>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::temperature };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::top_k>
		: public core_elem_base<global_input_types::top_k, sub_kernel_traits<config_type_new, global_input_types::top_k>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::top_p>
		: public core_elem_base<global_input_types::top_p, sub_kernel_traits<config_type_new, global_input_types::top_p>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::repetition_penalty>
		: public core_elem_base<global_input_types::repetition_penalty, sub_kernel_traits<config_type_new, global_input_types::repetition_penalty>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::presence_penalty>
		: public core_elem_base<global_input_types::presence_penalty, sub_kernel_traits<config_type_new, global_input_types::presence_penalty>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::frequency_penalty>
		: public core_elem_base<global_input_types::frequency_penalty, sub_kernel_traits<config_type_new, global_input_types::frequency_penalty>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::rep_window>
		: public core_elem_base<global_input_types::rep_window, sub_kernel_traits<config_type_new, global_input_types::rep_window>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::token_history>
		: public core_elem_base<global_input_types::token_history, sub_kernel_traits<config_type_new, global_input_types::token_history>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::token_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::context_length, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::token_history };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::rng_state>
		: public core_elem_base<global_input_types::rng_state, sub_kernel_traits<config_type_new, global_input_types::rng_state>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(256, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::rng_state };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::logits_bias>
		: public core_elem_base<global_input_types::logits_bias, sub_kernel_traits<config_type_new, global_input_types::logits_bias>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::vocab_size, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::logits_bias };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_input_types::allowed_vocab_mask>
		: public core_elem_base<global_input_types::allowed_vocab_mask, sub_kernel_traits<config_type_new, global_input_types::allowed_vocab_mask>> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::mask_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::vocab_size, 1ull, 1ull, 1)>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::get_array())),
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, token_embeddings_sub_kernel_types::token_embeddings_get_rows>
		: public core_elem_base<token_embeddings_sub_kernel_types::token_embeddings_get_rows,
			  sub_kernel_traits<config_type_new, token_embeddings_sub_kernel_types::token_embeddings_get_rows>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::token_embd>;
		using input_type_02				= sub_kernel_traits<config_type_new, global_input_types::inp_tokens>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::get_rows>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
		static constexpr auto sub_kernel_type{ token_embeddings_sub_kernel_types::token_embeddings_get_rows };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::norm_rms_norm>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::norm_rms_norm, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::norm_rms_norm>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, token_embeddings_sub_kernel_types::token_embeddings_get_rows>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::rms_norm>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::norm_rms_norm };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::attn_norm_mul>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::attn_norm_mul, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::attn_norm_mul>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::norm_rms_norm>;
		using input_type_02 = sub_kernel_traits<config_type_new, weight_types::attn_norm>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul>,
				typename input_type_01::dims_type, typename input_type_02::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::attn_norm_mul };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_mul_mat>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::q_mul_mat, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::attn_q>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::attn_norm_mul>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::q_mul_mat };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_reshape>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::q_reshape, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_reshape>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_mul_mat>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 2>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::rope_dimension_count,
				  model_traits_type<config_type_new>::attention_head_count, config_type_new::max_sequence_length, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::reshape>, target_dims,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::q_reshape };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_rope>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::q_rope, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_rope>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_reshape>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::inp_pos>;
		using input_type_03 = sub_kernel_traits<config_type_new, weight_types::rope_freqs>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::rope>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::q_rope };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_mul_mat>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_mul_mat, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::attn_k>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::attn_norm_mul>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_reshape>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_reshape, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_reshape>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_mul_mat>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 2>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::rope_dimension_count,
				  model_traits_type<config_type_new>::attention_head_count_kv, config_type_new::max_sequence_length, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::reshape>, target_dims,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::k_reshape };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_rope>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_rope, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_rope>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_reshape>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::inp_pos>;
		using input_type_03 = sub_kernel_traits<config_type_new, weight_types::rope_freqs>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::rope>, typename input_type_01::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_mul_mat>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_mul_mat, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::attn_v>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::attn_norm_mul>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_view>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_cache_view, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_view>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_input_types::cache_k>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(
				  model_traits_type<config_type_new>::n_embd_kv_gqa* config_type_new::max_sequence_length, 1ull, 1ull, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::view>, target_dims,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::k_cache_view };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_cpy>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_cache_cpy, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_cpy>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_rope>;
		using input_type_02 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_view>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::copy>, typename input_type_02::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::k_cache_cpy };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_transpose>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_transpose, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_transpose>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_mul_mat>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(config_type_new::max_sequence_length,
				  model_traits_type<config_type_new>::n_embd_kv_gqa, 1ull, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::transpose>, target_dims,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::v_transpose };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_view>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_cache_view, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_view>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_input_types::cache_v>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(config_type_new::max_sequence_length,
				  model_traits_type<config_type_new>::n_embd_kv_gqa, 1ull, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::view>, target_dims,
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_cpy>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_cache_cpy, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_cpy>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_transpose>;
		using input_type_02 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_view>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::copy>, typename input_type_02::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::v_cache_cpy };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_view>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_view, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_view>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_input_types::cache_v>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(config_type_new::max_sequence_length,
				  model_traits_type<config_type_new>::rope_dimension_count, model_traits_type<config_type_new>::attention_head_count_kv, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::view>, target_dims,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::v_view };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_view>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_view, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_view>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_input_types::cache_k>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::rope_dimension_count,
				  config_type_new::max_sequence_length, model_traits_type<config_type_new>::attention_head_count_kv, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::view>, target_dims,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::k_view };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_permute>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::q_permute, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_permute>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_rope>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::rope_dimension_count,
				  config_type_new::max_sequence_length, model_traits_type<config_type_new>::attention_head_count, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::permute>, target_dims,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_prep_and_score_sub_kernel_types::q_permute };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::kq_mul_mat>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::kq_mul_mat, sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::kq_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::attention_type;
		using input_type_01				= sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::k_view>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::q_permute>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kq_soft_max>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::kq_soft_max, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kq_soft_max>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::attention_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::kq_mul_mat>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::kq_mask>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::softmax>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::kq_soft_max };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::kqv_mul_mat, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, attn_prep_and_score_sub_kernel_types::v_view>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kq_soft_max>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_permute>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::kqv_permute, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_permute>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_mul_mat>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 2>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::rope_dimension_count,
				  model_traits_type<config_type_new>::attention_head_count, config_type_new::max_sequence_length, 1)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::permute>, target_dims,
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_cont>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::kqv_cont, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_cont>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_permute>;
		using target_dims	= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(model_traits_type<config_type_new>::embedding_length,
				  config_type_new::max_sequence_length, 1ull, 1ull)>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::cont>, target_dims,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::kqv_cont };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::attn_output_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::attn_output_mul_mat,
			  sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::attn_output_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::attn_output>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_cont>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_inp_add>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_inp_add, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_inp_add>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::attn_output_mul_mat>;
		using input_type_02 = sub_kernel_traits<config_type_new, token_embeddings_sub_kernel_types::token_embeddings_get_rows>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::add>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::ffn_inp_add };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_inp_add>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::rms_norm>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_mul>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_norm_mul, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_mul>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm>;
		using input_type_02 = sub_kernel_traits<config_type_new, weight_types::ffn_norm>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::ffn_norm_mul };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_gate_mul_mat, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::ffn_gate>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_mul>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_silu>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_gate_silu, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_silu>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_mul_mat>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::silu>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::ffn_gate_silu };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_up_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_up_mul_mat, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_up_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::ffn_up>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_mul>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_silu>;
		using input_type_02 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_up_mul_mat>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_down_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_down_mul_mat, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_down_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::ffn_down>;
		using input_type_02				= sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::layer_out_add>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::layer_out_add, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::layer_out_add>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_down_mul_mat>;
		using input_type_02 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_inp_add>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::add>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::layer_out_add };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::l_out_get_rows>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::l_out_get_rows, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::l_out_get_rows>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::layer_out_add>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::inp_out_ids>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::get_rows>,
				typename input_type_01::dims_type, typename input_type_02::dims_type>;
		static constexpr auto sub_kernel_type{ attn_out_and_ffn_sub_kernel_types::l_out_get_rows };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::extracted_add>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::extracted_add, sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::extracted_add>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::l_out_get_rows>;
		using input_type_02 = sub_kernel_traits<config_type_new, token_embeddings_sub_kernel_types::token_embeddings_get_rows>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::add>, typename input_type_01::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_rms_norm>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::output_norm_rms_norm,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_rms_norm>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, attn_out_and_ffn_sub_kernel_types::layer_out_add>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::rms_norm>, typename input_type_01::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_mul>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::output_norm_mul,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_mul>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_rms_norm>;
		using input_type_02 = sub_kernel_traits<config_type_new, weight_types::output_norm>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::output_norm_mul };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_projection_mul_mat>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::output_projection_mul_mat,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_projection_mul_mat>> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01				= sub_kernel_traits<config_type_new, weight_types::output>;
		using input_type_02				= sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_mul>;
		static constexpr bool quantized = !detail::is_same_v<output_type, typename input_type_01::output_type>;
		using dims_type					= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul_mat>,
							typename input_type_01::dims_type, typename input_type_02::dims_type>;
	...
	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_repetition_penalty>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_repetition_penalty,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_repetition_penalty>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::output_projection_mul_mat>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::token_history>;
		using input_type_03 = sub_kernel_traits<config_type_new, global_input_types::repetition_penalty>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::repetition_penalty>,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::apply_repetition_penalty };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_presence_penalty>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_presence_penalty,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_presence_penalty>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_repetition_penalty>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::token_history>;
		using input_type_03 = sub_kernel_traits<config_type_new, global_input_types::presence_penalty>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::presence_penalty>,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::apply_presence_penalty };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_frequency_penalty>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_frequency_penalty,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_frequency_penalty>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_presence_penalty>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::token_history>;
		using input_type_03 = sub_kernel_traits<config_type_new, global_input_types::frequency_penalty>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::frequency_penalty>,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::apply_frequency_penalty };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_logits_bias>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_logits_bias,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_logits_bias>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_frequency_penalty>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::logits_bias>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::add>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::apply_logits_bias };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_vocab_mask>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_vocab_mask,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_vocab_mask>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_logits_bias>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::allowed_vocab_mask>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::mul>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::apply_vocab_mask };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_temperature>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_temperature,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_temperature>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_vocab_mask>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::temperature>;
		using dims_type		= dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::temperature_scale>,
				typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::apply_temperature };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::compute_softmax>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::compute_softmax,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::compute_softmax>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_temperature>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::softmax>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::compute_softmax };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_k_filter>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_top_k_filter,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_k_filter>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::compute_softmax>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::top_k>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::top_k_filter>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::apply_top_k_filter };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_p_filter>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_top_p_filter,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_p_filter>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_k_filter>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::top_p>;
		using dims_type =
			dim_traits_new_t<config_type_new::batched_processing, config_type_new::batch_size, kernel_types_type<kernel_types::top_p_filter>, typename input_type_01::dims_type>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::apply_top_p_filter };
	};

	template<typename config_type_new> struct sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::sample_token>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::sample_token,
			  sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::sample_token>> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::token_type;
		using input_type_01 = sub_kernel_traits<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_p_filter>;
		using input_type_02 = sub_kernel_traits<config_type_new, global_input_types::rng_state>;
		using dims_type		= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
				get_shifted_dimensions<config_type_new::batched_processing, config_type_new::batch_size>(1ull, 1ull, 1ull, 1)>;
		static constexpr auto sub_kernel_type{ global_output_and_sampling_sub_kernel_types::sample_token };
	};

	template<typename config_type_new, typename enum_type> struct sub_kernel_aggregator;

	template<llama_arch_config_types config_type_new> struct sub_kernel_aggregator<config_type_new, weight_types> {
	...
	template<llama_arch_config_types config_type_new> struct sub_kernel_aggregator<config_type_new, global_input_types> {
	...
	template<llama_arch_config_types config_type_new> struct sub_kernel_aggregator<config_type_new, token_embeddings_sub_kernel_types> {
		static constexpr array values{ token_embeddings_sub_kernel_types::token_embeddings_get_rows };
	};

	template<llama_arch_config_types config_type_new> struct sub_kernel_aggregator<config_type_new, attn_prep_and_score_sub_kernel_types> {
	...
	template<llama_arch_config_types config_type_new> struct sub_kernel_aggregator<config_type_new, attn_out_and_ffn_sub_kernel_types> {
	...
	template<llama_arch_config_types config_type_new> struct sub_kernel_aggregator<config_type_new, global_output_and_sampling_sub_kernel_types> {
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::attn_q>
		: public core_elem_base<weight_types::attn_q, sub_kernel_traits_new<config_type_new, weight_types::attn_q>>,
		  public kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::attn_q>::dims> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::attn_q>::dims>;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::attn_k>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::attn_k>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::attn_k };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::attn_v>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::attn_v>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::attn_v };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::attn_output>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::attn_output>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::attn_output };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::attn_norm>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::norm_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::attn_norm>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::attn_norm };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::ffn_gate>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::ffn_gate>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::ffn_gate };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::ffn_up>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::ffn_up>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::ffn_up };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::ffn_down>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::ffn_down>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::ffn_down };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::ffn_norm>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::norm_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::ffn_norm>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::per_block> };
		static constexpr auto sub_kernel_type{ weight_types::ffn_norm };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::token_embd>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::token_embd>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ weight_types::token_embd };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::rope_freqs>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::rope_freqs>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ weight_types::rope_freqs };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::output_norm>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::norm_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::output_norm>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ weight_types::output_norm };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, weight_types::output>
		...
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::weight_type;
		using dims_type	  = kernel_dims_new<0, dim_traits_newer<config_type_new, weight_types::output>::dims>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ weight_types::output };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::inp_tokens>
		: public core_elem_base<global_input_types::inp_tokens, sub_kernel_traits_new<config_type_new, global_input_types::inp_tokens>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::inp_tokens>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::token_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::inp_tokens>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::inp_pos>
		: public core_elem_base<global_input_types::inp_pos, sub_kernel_traits_new<config_type_new, global_input_types::inp_pos>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::inp_pos>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::inp_pos>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::cache_k>
		: public core_elem_base<global_input_types::cache_k, sub_kernel_traits_new<config_type_new, global_input_types::cache_k>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::cache_k>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::cache_k>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::cache_v>
		: public core_elem_base<global_input_types::cache_v, sub_kernel_traits_new<config_type_new, global_input_types::cache_v>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::cache_v>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::cache_v>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::kq_mask>
		: public core_elem_base<global_input_types::kq_mask, sub_kernel_traits_new<config_type_new, global_input_types::kq_mask>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::kq_mask>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::mask_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::kq_mask>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::inp_out_ids>
		: public core_elem_base<global_input_types::inp_out_ids, sub_kernel_traits_new<config_type_new, global_input_types::inp_out_ids>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::inp_out_ids>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::inp_out_ids>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::temperature>
		: public core_elem_base<global_input_types::temperature, sub_kernel_traits_new<config_type_new, global_input_types::temperature>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::temperature>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::temperature>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::top_k>
		: public core_elem_base<global_input_types::top_k, sub_kernel_traits_new<config_type_new, global_input_types::top_k>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::top_k>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::top_k>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::top_p>
		: public core_elem_base<global_input_types::top_p, sub_kernel_traits_new<config_type_new, global_input_types::top_p>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::top_p>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::top_p>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
		...
		: public core_elem_base<global_input_types::repetition_penalty, sub_kernel_traits_new<config_type_new, global_input_types::repetition_penalty>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::repetition_penalty>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::repetition_penalty>>()>;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::presence_penalty>
		: public core_elem_base<global_input_types::presence_penalty, sub_kernel_traits_new<config_type_new, global_input_types::presence_penalty>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::presence_penalty>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::presence_penalty>>()>;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::frequency_penalty>
		: public core_elem_base<global_input_types::frequency_penalty, sub_kernel_traits_new<config_type_new, global_input_types::frequency_penalty>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::frequency_penalty>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::frequency_penalty>>()>;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::rep_window>
		: public core_elem_base<global_input_types::rep_window, sub_kernel_traits_new<config_type_new, global_input_types::rep_window>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::rep_window>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::rep_window>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::token_history>
		: public core_elem_base<global_input_types::token_history, sub_kernel_traits_new<config_type_new, global_input_types::token_history>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::token_history>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::token_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::token_history>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
			model_traits_type<config_type_new>::block_count, data_strategy_types::global> };
		static constexpr auto sub_kernel_type{ global_input_types::token_history };
	};
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::rng_state>
		: public core_elem_base<global_input_types::rng_state, sub_kernel_traits_new<config_type_new, global_input_types::rng_state>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::rng_state>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::index_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::rng_state>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::logits_bias>
		: public core_elem_base<global_input_types::logits_bias, sub_kernel_traits_new<config_type_new, global_input_types::logits_bias>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::logits_bias>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size, dim_traits_newer<config_type_new, global_input_types::logits_bias>>()>;
		static constexpr uint64_t total_required_bytes{ get_total_required_bytes<round_up_to_multiple<64>(type_traits<output_type>::total_byte_size(dims_type::dims)),
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_input_types::allowed_vocab_mask>
		: public core_elem_base<global_input_types::allowed_vocab_mask, sub_kernel_traits_new<config_type_new, global_input_types::allowed_vocab_mask>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::allowed_vocab_mask>>()> {
		using output_type = typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::mask_type;
		using dims_type	  = kernel_dims_new<get_runtime_mask<config_type_new::batched_processing>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_input_types::allowed_vocab_mask>>()>;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, token_embeddings_sub_kernel_types::token_embeddings_get_rows>
		: public core_elem_base<token_embeddings_sub_kernel_types::token_embeddings_get_rows,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, token_embeddings_sub_kernel_types::token_embeddings_get_rows>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::norm_rms_norm>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::norm_rms_norm, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::norm_rms_norm>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::norm_rms_norm>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::attn_norm_mul>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::attn_norm_mul, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::attn_norm_mul>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::attn_norm_mul>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::q_mul_mat>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::q_mul_mat, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::q_mul_mat>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::q_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::q_reshape>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::q_reshape, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::q_reshape>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 2>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::q_reshape>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::q_rope>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::q_rope, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::q_rope>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 2>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::q_rope>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_mul_mat>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_mul_mat, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_mul_mat>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::k_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_reshape>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_reshape, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_reshape>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 2>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::k_reshape>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_rope>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_rope, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_rope>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 2>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::k_rope>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_mul_mat>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_mul_mat, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_mul_mat>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::v_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_view>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_cache_view, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_view>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_view>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_cpy>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_cache_cpy, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_cpy>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::k_cache_cpy>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_transpose>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_transpose, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_transpose>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::v_transpose>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_view>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_cache_view, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_view>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_view>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_cpy>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_cache_cpy, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_cpy>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::v_cache_cpy>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_view>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::v_view, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::v_view>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::v_view>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using input_type_01 = sub_kernel_traits_new<config_type_new, global_input_types::cache_v>;
		using dims_type		= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 0>(),
				get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_view>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::k_view, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::k_view>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::k_view>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::kv_cache_type;
		using input_type_01 = sub_kernel_traits_new<config_type_new, global_input_types::cache_k>;
		using dims_type		= kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
				get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::q_permute>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::q_permute, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::q_permute>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::q_permute>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::kq_mul_mat>
		: public core_elem_base<attn_prep_and_score_sub_kernel_types::kq_mul_mat, sub_kernel_traits_new<config_type_new, attn_prep_and_score_sub_kernel_types::kq_mul_mat>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_prep_and_score_sub_kernel_types::kq_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::attention_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::kq_soft_max>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::kq_soft_max, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::kq_soft_max>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::kq_soft_max>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::attention_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::kqv_mul_mat, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_mul_mat>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 2>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_permute>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::kqv_permute, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_permute>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_permute>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_cont>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::kqv_cont, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_cont>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::kqv_cont>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::attn_output_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::attn_output_mul_mat,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::attn_output_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_inp_add>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_inp_add, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_inp_add>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_inp_add>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_rms_norm>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_mul>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_norm_mul, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_mul>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_norm_mul>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_gate_mul_mat, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_mul_mat>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_silu>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_gate_silu, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_silu>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_silu>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_up_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_up_mul_mat, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_up_mul_mat>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_up_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_gate_par_mul>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_down_mul_mat>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::ffn_down_mul_mat, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_down_mul_mat>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::ffn_down_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::layer_out_add>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::layer_out_add, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::layer_out_add>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::layer_out_add>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::l_out_get_rows>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::l_out_get_rows, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::l_out_get_rows>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::l_out_get_rows>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::extracted_add>
		: public core_elem_base<attn_out_and_ffn_sub_kernel_types::extracted_add, sub_kernel_traits_new<config_type_new, attn_out_and_ffn_sub_kernel_types::extracted_add>>,
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, attn_out_and_ffn_sub_kernel_types::extracted_add>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_rms_norm>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::output_norm_rms_norm,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_rms_norm>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_mul>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::output_norm_mul,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::output_norm_mul>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::compute_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::output_projection_mul_mat>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::output_projection_mul_mat,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::output_projection_mul_mat>>()> {
		using output_type				= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::apply_repetition_penalty>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_repetition_penalty,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::apply_repetition_penalty>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::apply_presence_penalty>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_presence_penalty,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::apply_presence_penalty>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::apply_frequency_penalty>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_frequency_penalty,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::apply_frequency_penalty>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::apply_logits_bias>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_logits_bias,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::apply_logits_bias>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::apply_vocab_mask>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_vocab_mask,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::apply_vocab_mask>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::apply_temperature>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_temperature,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::apply_temperature>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::compute_softmax>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::compute_softmax,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::compute_softmax>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_k_filter>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_top_k_filter,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_k_filter>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_p_filter>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::apply_top_p_filter,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::apply_top_p_filter>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::logit_type;
	...
	template<typename config_type_new> struct sub_kernel_traits_new<config_type_new, global_output_and_sampling_sub_kernel_types::sample_token>
		: public core_elem_base<global_output_and_sampling_sub_kernel_types::sample_token,
		  ...
		  public kernel_dims_new<get_runtime_mask<config_type_new::batched_processing, 1>(),
			  get_shifted_dimensions_new<config_type_new::batched_processing, config_type_new::batch_size,
				  dim_traits_newer<config_type_new, global_output_and_sampling_sub_kernel_types::sample_token>>()> {
		using output_type	= typename kernel_type_profile_traits<config_type_new::kernel_type_profile>::token_type;
