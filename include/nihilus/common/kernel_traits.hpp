...
namespace nihilus {
	...
	template<auto op_type, double_input core_type> struct kernel_traits<op_type, kernel_type::mul_mat, core_type, typename core_type::output_type,
		...
		static_assert(static_assert_printer<(dims02[0] == dims03[0]), kernel_trait_static_assert_errors::MUL_MAT_Weight_rows_must_match_input_vector_size, kernel_traits, output,
			input01, input02>::impl);
		static_assert(static_assert_printer<(dims01[0] == dims02[1]), kernel_trait_static_assert_errors::MUL_MAT_Output_size_must_match_weight_columns, kernel_traits, output,
			input01, input02>::impl);
		static_assert(static_assert_printer<(dims02[2] == dims03[2] || (dims02[2] * (dims03[2] / dims02[2]) == dims03[2])),
		...
		static_assert(static_assert_printer<(dims01[2] == dims03[2]), kernel_trait_static_assert_errors::MUL_MAT_Output_head_count_must_match_attention_head_count, kernel_traits,
			output, input01, input02>::impl);
		static_assert(static_assert_printer<(dims02[3] == dims03[3]), kernel_trait_static_assert_errors::MUL_MAT_Batch_dimension_3_must_match, kernel_traits, output, input01,
			input02>::impl);
		static_assert(static_assert_printer<(dims01[3] == dims03[3]), kernel_trait_static_assert_errors::MUL_MAT_Output_batch_dimension_3_must_match_attention_dimensions,
