...
namespace nihilus {
	...
	template<model_config config_new> struct core_traits<config_new, op_types::norm_attn_norm>
		...
		using transform_type															   = output_transform<input_type01::kernel_type, input_type02::kernel_type>;
	...
	template<model_config config_new> struct core_traits<config_new, op_types::qcur_reshaped>
		: public config_holder<config_new>, public get_new_dims_1_t<config_new, kernel_types::reshape, op_types::qcur, runtime_dims<1>> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::query_type;
		using core_traits_dims_type														   = get_new_dims_1_t<config_new, kernel_types::reshape, op_types::qcur, runtime_dims<1>>;
	...
	template<model_config config_new> struct core_traits<config_new, op_types::qcur_rope>
		: public config_holder<config_new>,
		  public get_new_dims<kernel_types::rope, core_traits<config_new, op_types::qcur_reshaped>, core_traits<config_new, op_types::inp_pos>,
			  core_traits<config_new, op_types::rope_freqs_weight>, runtime_dims<2>>::type {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::query_type;
		using core_traits_dims_type = get_new_dims<kernel_types::rope, core_traits<config_new, op_types::qcur_reshaped>, core_traits<config_new, op_types::inp_pos>,
			core_traits<config_new, op_types::rope_freqs_weight>, runtime_dims<2>>::type;
		static constexpr uint64_t depth{ detail::max(input_type01::depth, input_type02::depth) + 1 };
		static constexpr bool dequantization{ requires_dequant_or_quant<typename input_type01::output_type, typename input_type02::output_type>::required };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kcur>
		: public config_holder<config_new>,
		  public get_new_dims<kernel_types::mul_mat, core_traits<config_new, op_types::attn_k_weight>, core_traits<config_new, op_types::norm_attn_norm>, runtime_dims<1>>::type {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using core_traits_dims_type =
			get_new_dims<kernel_types::mul_mat, core_traits<config_new, op_types::attn_k_weight>, core_traits<config_new, op_types::norm_attn_norm>, runtime_dims<1>>::type;
		static constexpr uint64_t depth{ detail::max(input_type01::depth, input_type02::depth) + 1 };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kcur_reshaped>
		: public config_holder<config_new>, public get_new_dims<kernel_types::reshape, core_traits<config_new, op_types::kcur>, runtime_dims<1>>::type {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::key_type;
		using core_traits_dims_type = get_new_dims<kernel_types::reshape, core_traits<config_new, op_types::kcur>, runtime_dims<1>>::type;
		static constexpr uint64_t depth{ input_type01::depth + 1 };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kcur_rope>
		: public config_holder<config_new>,
		  public get_new_dims<kernel_types::rope, core_traits<config_new, op_types::kcur_reshaped>, core_traits<config_new, op_types::inp_pos>,
			  core_traits<config_new, op_types::rope_freqs_weight>, runtime_dims<1>>::type {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using input_type03																   = core_traits<config_new, op_types::rope_freqs_weight>;
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::key_type;
		using core_traits_dims_type = get_new_dims<kernel_types::rope, core_traits<config_new, op_types::kcur_reshaped>, core_traits<config_new, op_types::inp_pos>,
			core_traits<config_new, op_types::rope_freqs_weight>, runtime_dims<1>>::type;
	...
	template<model_config config_new> struct core_traits<config_new, op_types::vcur>
		: public config_holder<config_new>,
		  public core_trait_dims<model_traits_type<config_new>::head_dim * model_traits_type<config_new>::attention_head_count_kv,
			  model_traits_type<config_new>::feed_forward_length, 1, 1, 1> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using core_traits_dims_type = core_trait_dims<model_traits_type::head_dim * model_traits_type::attention_head_count_kv, model_traits_type::feed_forward_length, 1, 1, 1>;
		static constexpr uint64_t depth{ detail::max(input_type01::depth, input_type02::depth) + 1 };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::k_cache_view>
		: public config_holder<config_new>, public core_trait_dims<2, model_traits_type<config_new>::attention_head_count_kv * model_traits_type<config_new>::head_dim, 1, 1, 1> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::kv_cache_type;
		using core_traits_dims_type = core_trait_dims<1, model_traits_type::attention_head_count_kv * model_traits_type::head_dim, model_traits_type::feed_forward_length, 1, 1>;
		static constexpr uint64_t depth{ input_type01::depth + 1 };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::k_cache_view_copy>
		: public config_holder<config_new>,
		  core_trait_dims<model_traits_type<config_new>::attention_head_count_kv * model_traits_type<config_new>::head_dim, model_traits_type<config_new>::feed_forward_length, 1,
			  1, 1> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		...
		using core_traits_dims_type = core_trait_dims<model_traits_type::n_embd_kv_gqa, model_traits_type::feed_forward_length, 1, 1, 1>;
		static constexpr uint64_t depth{ input_type01::depth + 1 };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::vcur_transposed>
		: public config_holder<config_new>,
		  core_trait_dims<model_traits_type<config_new>::feed_forward_length, model_traits_type<config_new>::head_dim * model_traits_type<config_new>::attention_head_count_kv, 1,
			  1, 0> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		...
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::value_type;
		using core_traits_dims_type = core_trait_dims<model_traits_type::feed_forward_length, model_traits_type::head_dim * model_traits_type::attention_head_count_kv, 1, 1, 0>;
		static constexpr uint64_t depth{ input_type01::depth + 1 };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ 0 };
		static constexpr thread_strategy_type layer_type{ thread_strategy_type::per_block };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::v_cache_view>
		: public config_holder<config_new>, core_trait_dims<2, model_traits_type<config_new>::attention_head_count_kv * model_traits_type<config_new>::head_dim, 1, 1, 1> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
	...
	template<model_config config_new> struct core_traits<config_new, op_types::v_cache_view_copy>
		: public config_holder<config_new>,
		  core_trait_dims<model_traits_type<config_new>::feed_forward_length, model_traits_type<config_new>::attention_head_count_kv * model_traits_type<config_new>::head_dim, 1,
			  1, 0> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		...
		using core_traits_dims_type = core_trait_dims<model_traits_type::feed_forward_length, model_traits_type::n_embd_kv_gqa, 1, 1, 0>;
		static constexpr uint64_t depth{ input_type01::depth + 1 };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ 0 };
		static constexpr thread_strategy_type layer_type{ thread_strategy_type::per_block };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::v>
		: public config_holder<config_new>,
		  core_trait_dims<model_traits_type<config_new>::head_dim, model_traits_type<config_new>::block_count, model_traits_type<config_new>::attention_head_count_kv, 1, 1> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using core_traits_dims_type = core_trait_dims<model_traits_type::feed_forward_length, model_traits_type::head_dim, model_traits_type::attention_head_count_kv, 1, 1>;
		static constexpr uint64_t depth{ input_type01::depth + 1 };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ 0 };
		static constexpr thread_strategy_type layer_type{ thread_strategy_type::per_block };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::k>
		...
		using input_type01																   = core_traits<config_new, op_types::cache_k>;
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::kv_cache_type;
		using core_traits_dims_type = core_trait_dims<model_traits_type::head_dim, model_traits_type::block_count, model_traits_type::attention_head_count_kv, 1, 1>;
		static constexpr uint64_t depth{ input_type01::depth + 1 };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ 0 };
		static constexpr thread_strategy_type layer_type{ thread_strategy_type::per_block };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::q>
		: public config_holder<config_new>,
		  core_trait_dims<model_traits_type<config_new>::head_dim, model_traits_type<config_new>::feed_forward_length, model_traits_type<config_new>::attention_head_count, 1, 1> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::query_type;
		using core_traits_dims_type = core_trait_dims<model_traits_type::head_dim, model_traits_type::feed_forward_length, model_traits_type::attention_head_count, 1, 1>;
		static constexpr uint64_t depth{ input_type01::depth + 1 };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ 0 };
		static constexpr thread_strategy_type layer_type{ thread_strategy_type::per_block };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kq>
		: public config_holder<config_new>, core_trait_dims<model_traits_type<config_new>::feed_forward_length, 1, model_traits_type<config_new>::attention_head_count, 1, 0> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using core_traits_dims_type = core_trait_dims<model_traits_type::feed_forward_length, 1, model_traits_type::attention_head_count, 1, 0>;
		static constexpr uint64_t depth{ detail::max(input_type01::depth, input_type02::depth) + 1 };
		static constexpr bool dequantization{ requires_dequant_or_quant<typename input_type01::output_type, typename input_type02::output_type>::required };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ round_up_to_multiple<cpu_alignment>(type_traits<output_type>::total_byte_size(core_traits_dims_type::get_array()) +
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kq_soft_max>
		: public config_holder<config_new>, core_trait_dims<model_traits_type<config_new>::attention_head_count, 1, model_traits_type<config_new>::attention_head_count, 1, 0> {
		...
		using core_traits_dims_type = core_trait_dims<model_traits_type::attention_head_count, model_traits_type::head_dim, model_traits_type::attention_head_count, 1, 0>;
		static constexpr uint64_t depth{ detail::max(input_type01::depth, input_type02::depth) + 1 };
		static constexpr bool dequantization{ requires_dequant_or_quant<typename input_type01::output_type, typename input_type02::output_type>::required };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ round_up_to_multiple<cpu_alignment>(type_traits<output_type>::total_byte_size(core_traits_dims_type::get_array()) +
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kqv>
		: public config_holder<config_new>, core_trait_dims<model_traits_type<config_new>::head_dim, 1, model_traits_type<config_new>::attention_head_count, 1> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using output_type																   = typename kernel_type_profile_traits<config_new.kernel_profile>::value_type;
		using core_traits_dims_type = core_trait_dims<model_traits_type::head_dim, 1, model_traits_type::attention_head_count, 1>;
		static constexpr uint64_t depth{ detail::max(input_type01::depth, input_type02::depth) + 1 };
		static constexpr bool dequantization{ requires_dequant_or_quant<typename input_type01::output_type, typename input_type02::output_type>::required };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ round_up_to_multiple<cpu_alignment>(type_traits<output_type>::total_byte_size(core_traits_dims_type::get_array()) +
	...
	template<model_config config_new> struct core_traits<config_new, op_types::result_output>
		: public config_holder<config_new>, core_trait_dims<model_traits_type<config_new>::vocab_size, model_traits_type<config_new>::feed_forward_length, 1, 1, 1> {
		NIHILUS_FORCE_INLINE constexpr core_traits() noexcept							   = default;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits(const core_traits&) noexcept			   = delete;
		NIHILUS_FORCE_INLINE constexpr core_traits& operator=(core_traits&&) noexcept	   = delete;
		...
		using core_traits_dims_type = core_trait_dims<model_traits_type::vocab_size, model_traits_type::feed_forward_length, 1, 1, 1>;
		static constexpr uint64_t depth{ detail::max(input_type01::depth, input_type02::depth) + 1 };
		static constexpr bool dequantization{ requires_dequant_or_quant<typename input_type01::output_type, typename input_type02::output_type>::required };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
		static constexpr uint64_t total_required_bytes{ round_up_to_multiple<cpu_alignment>(type_traits<output_type>::total_byte_size(core_traits_dims_type::get_array()) +
	...
	template<kernel_types kernel_type, core_traits_type core_traits01, core_traits_type core_traits02, core_traits_type core_traits03, runtime_dims_t... dimension_type>
	...
	template<kernel_types kernel_type, core_traits_type core_traits01, core_traits_type core_traits02, runtime_dims_t... dimension_type>
	...
	template<kernel_types kernel_type, core_traits_type core_traits01, runtime_dims_t... dimension_type> struct get_new_dims<kernel_type, core_traits01, dimension_type...> {
		using dim_traits01			 = typename core_traits01::core_traits_dims_type;
		static constexpr auto dims01 = dim_traits01::get_array();
