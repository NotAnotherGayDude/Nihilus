...
namespace nihilus {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, kernel_type::add_rms_norm_mul, transform_type, core_type, float, float, float>
